...
local zoom = 7 --Your desired scope zoom
local fov = 90 / zoom / 2 --Put this at the top; RT FOV

ATTACHMENT.Name = "Dual Band Scope"
ATTACHMENT.Description = {TFA.AttachmentColors["="], "Low Power Scope", TFA.AttachmentColors["-"], "Not Actually Thermal :v"}
ATTACHMENT.Icon = "entities/bo2_dualband.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "DUALBND"

ATTACHMENT.WeaponTable = {
	["VElements"] = {
		["bo2_dualband_rtcircle"] = {
			["active"] = true
		},
		["original_rtcircle"] = {
			["active"] = false
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_DB or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_DB or val, true end,
		["Primary"] = {
...
local myret = Material("scope/gdcw_elcanreticle")
