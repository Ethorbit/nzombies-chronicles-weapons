...
SWEP.Primary.Spread		= .049	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .049	-- Ironsight accuracy, should be the same for shotguns
