...
SWEP.Primary.ClipSize_XM			= 7		-- Size of a clip
...
SWEP.SightsPos = Vector(-3.84, -6.868, 0.89)
SWEP.SightsAng = Vector(1.2, 0.1, 0)
SWEP.RunSightsPos = Vector ()
SWEP.RunSightsAng = Vector ()
SWEP.InspectPos = Vector(8.88, -3.606, 2.119)
SWEP.InspectAng = Vector(9.699, 34.599, 18.5)
