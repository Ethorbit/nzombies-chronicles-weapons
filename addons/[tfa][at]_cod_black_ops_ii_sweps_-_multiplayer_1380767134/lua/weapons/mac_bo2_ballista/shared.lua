...
SWEP.Primary.Damage		= 99	-- Base damage per bullet
...
SWEP.SightsPos = Vector(-4.134, -4.697, -0.005)
SWEP.SightsAng = Vector(1, 0.699, 0)
SWEP.RunSightsPos = Vector ()
SWEP.RunSightsAng = Vector ()
SWEP.InspectPos = Vector(6.611, -6.621, -0.926)
SWEP.InspectAng = Vector(23.399, 41, 13.6)
SWEP.IronSightsPos_IRON = Vector(-4.174, -6.736, 0.699)
