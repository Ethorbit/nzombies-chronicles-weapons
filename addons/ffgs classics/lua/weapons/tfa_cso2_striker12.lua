...
function SWEP:OnPaP()
	...
	self.Primary.Damage = 83
	self.Primary.RPM = 372
...
SWEP.VMPos = Vector(0,0,-1.5) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
