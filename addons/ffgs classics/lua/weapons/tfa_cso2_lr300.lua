...
SWEP.PrintName				= "LR300"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_lr300.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_lr300.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_lr300.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.61, -11.216, 1.28)
SWEP.IronSightsAng = Vector(0.20, -0.48, 6.066)
