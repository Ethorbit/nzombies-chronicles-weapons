...
SWEP.PrintName				= "Triple Action Thunder"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_thunder.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Displayed = 30
 -- This is in Rounds Per Minute / RPM

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Magic Bullet"
...
function SWEP:OnPaP()
	...
	self.SequenceRateOverride = {[ACT_VM_RELOAD] = 4, [ACT_VM_RELOAD_EMPTY] = 4} --Like above but changes animation length to a target
	self.SequenceRateOverrideScaled = {[ACT_VM_RELOAD] = 4, [ACT_VM_RELOAD_EMPTY] = 4} --Like above but scales animation length rather than being absolute
	self.Primary.MaxAmmo = 50
	self.Primary.DefaultClip = 50
	self.Primary.Damage = 800
...
--Range Related
SWEP.Primary.Range = 150 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_thunder.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_thunder.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(0, -10, -5)
SWEP.RunSightsAng = Vector(55, 5, 0)
...
SWEP.IronSightsPos = Vector(5.96, 0, 2.4)
SWEP.IronSightsAng = Vector(-1.101, 0.1, 0)
