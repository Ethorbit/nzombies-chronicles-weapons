...
SWEP.PrintName				= "Desert Eagle Red"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPReplacement 	= "tfa_cso2_dep"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_deserteaglered.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_deserteaglered.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.8, 0, 1.65)
