...
function SWEP:OnPaP()
	...
	self.Primary.Damage = 7000
	self.ProjectileEntity = "black_dragon_cannon_nade2"
end
...
SWEP.JumpRecoilMultiplier=0  --Multiply recoil by this factor when we're crouching.  This is proportional, not inversely.
