...
SWEP.PrintName				= "MP7 Phoenix"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_mp7phoenix.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Hellfire"
--SWEP.NZPaPReplacement 	= "tfa_cso2_mp7_phoenix"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Range Related
SWEP.Primary.Range = 550 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 0.5 -- The percentage of the range the bullet damage starts to mp7phoenixl off at.  Set to 0.8, for example, to start mp7phoenixling off after 80% of the range.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_mp7_ss_phoenix.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_mp7_ss_phoenix.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.25, -6.265, 3.339)
SWEP.IronSightsAng = Vector(-1.086, -0.051, 0)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.0,-3,-0.03)
