...
function SWEP:OnPaP()
	...
	self.TracerName = "cso_tra_shark_pap"
	self.VElements = {
		["smoke_right"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "bone_gill02", rel = "", pos = Vector(1, 2.5, -3), angle = Angle(90, 0, 20), size = Vector(0.25, 0.25, 0.25), color = Color(255, 0, 0, 255), surpresslightning = false, material = "sprites/m3shark_smoke2", skin = 0, bodygroup = {} },
		["smoke_left"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "bone_gill02", rel = "", pos = Vector(-6, 2.5, 2), angle = Angle(0, 0, 0), size = Vector(0.25, 0.25, 0.25), color = Color(255, 0, 0, 255), surpresslightning = false, material = "sprites/m3shark_smoke", skin = 0, bodygroup = {} }
	}
	self.Primary.MaxAmmo = 95
	self.Primary.RPM = 200
	self.Primary.RPM_Semi = 200
