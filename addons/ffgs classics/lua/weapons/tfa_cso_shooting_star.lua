...
SWEP.PrintName				= "Shooting Star"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("ShootingStar.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ProjectileEntity = "star_nade" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_shooting_star.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_shooting_star.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.3, 0, 2.25)
SWEP.IronSightsAng = Vector(-5, -0.35, 1)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_shooting_star")
