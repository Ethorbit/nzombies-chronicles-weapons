...
SWEP.IgniteChance = 100
SWEP.IgniteDamage = 15
SWEP.IgniteRadius = 3
SWEP.IgniteDuration = 3
...
SWEP.Secondary.Ammo = "BURNINGAUG_NADE"
SWEP.Secondary.Ent = "burningaug_nade"

game.AddAmmoType({
	name = "BURNINGAUG_NADE",
	dmgtype = DMG_BLAST
})

SWEP.Secondary.Model = "models/weapons/tfa_cso/w_shell_svdex.mdl" --Projectile Model
SWEP.Secondary.Damage = 240 --Grenade Damage
SWEP.Secondary.Velocity = 1400 --Grenade Velocity
...
function SWEP:NZMaxAmmo()
	...
	if (self:HasNZModifier("pap")) then
		self.Owner:SetAmmo(13, "BURNINGAUG_NADE")
	else
		self.Owner:SetAmmo(5, "BURNINGAUG_NADE")
	end
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = 125
	self.Primary.DamageHeadshot = 3
	self.IgniteDamage = 35
end
...
SWEP.Primary.IronAccuracy = .01125	-- Ironsight accuracy, should be the same for shotguns
