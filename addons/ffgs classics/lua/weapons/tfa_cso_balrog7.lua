...
SWEP.PrintName				= "BALROG-VII"		-- Weapon name (Shown on HUD)
...
SWEP.IgniteDamage = 50
SWEP.IgniteRadius = 3
SWEP.IgniteDuration = 4

--[[WEAPON HANDLING]]--

--Firing related
SWEP.Primary.Sound 			= Sound("BALROG7.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "FALLICA-14"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_balrog_7.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_balrog7blue","cso_balrog7poison" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_balrog7.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.639, 0, 1.08)
