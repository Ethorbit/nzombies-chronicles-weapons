...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_usp.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("tfa_cso2_usp.2") -- This is the sound of the weapon, when silenced.
...
SWEP.NZPaPName				= "United Slayer Popper"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_usp.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_usp.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.28, -1.188, 2.559)
SWEP.IronSightsAng = Vector(1.6, 0, 0.572)
...
SWEP.BlowbackVector = Vector(-0.0,-2,0.05) --Vector to move bone <or root> relative to bone <or view> orientation.
SWEP.BlowbackCurrentRoot = 0 --Amount of blowback currently, for root
SWEP.BlowbackCurrent = 0 --Amount of blowback currently, for bones
SWEP.BlowbackBoneMods = {
	["weapon.USP_Slide"] = { scale = Vector(1, 1, 1), pos = Vector(-1.591, 0, 0), angle = Angle(0, 0, 0) }
