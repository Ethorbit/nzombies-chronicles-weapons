...
SWEP.Primary.Damage = 320 -- Damage, in standard damage points.
...
SWEP.NZPaPReplacement 	= "tfa_cso_desperado_v6"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
