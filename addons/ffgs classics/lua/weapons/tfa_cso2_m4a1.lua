...
SWEP.NZPaPName				= "M8A2 Power"
SWEP.NZPaPReplacement 	= "tfa_cso2_m4a1_gold"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m4a1.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m4a1.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.557, -6.079, 1.157)
SWEP.IronSightsAng = Vector(2.684, 0.071, 1.72)
