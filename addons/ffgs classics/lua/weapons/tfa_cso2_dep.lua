...
SWEP.PrintName				= "Desert Phoenix"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 1				-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 73			-- Position in the slot
SWEP.AutoSwitchTo			= true		-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= true		-- Auto switch from if you pick up a better weapon
SWEP.Weight				= 30			-- This controls how "good" the weapon is for autopickup.
SWEP.NZRePaPText = "upgrade weapon"
SWEP.VMMultX = -2.15

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_dep.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZRePaPText		= "get another Desert Phoenix"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Osiris' Sight"
SWEP.NZPaPReplacement 	= "tfa_cso2_ddep"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_dep.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_dep.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.18, -2.188, 3.619)
SWEP.IronSightsAng = Vector(-3.84, -0.08, 0)
...
SWEP.BlowbackBoneMods = {
	["CSO2_Deagle_YAGSIL_l"] = { scale = Vector(1, 1, 1), pos = Vector(0, 2, 0), angle = Angle(0, 0, 0) }
