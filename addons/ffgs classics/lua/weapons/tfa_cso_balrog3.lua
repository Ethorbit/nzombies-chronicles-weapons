...
SWEP.PrintName				= "BALROG-III"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("BALROG3.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "FALLICA-6"	-- What name this weapon should use when Pack-a-Punched.
...
function SWEP:OnPaP()
	...
	self.IgniteDamage = 65
	self.IgniteChance = 10
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_balrog_3.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_balrog3blue","cso_balrog3poison" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_balrog_3.mdl" -- Worldmodel path
