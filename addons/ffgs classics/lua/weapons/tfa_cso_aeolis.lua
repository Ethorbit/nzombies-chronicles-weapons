...
SWEP.PrintName				= "Aeolis"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Aeolis.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "Cecilia"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.Primary.DefaultClip			= 440				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
SWEP.Primary.Ammo			= "ar2"					-- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
--Pistol, buckshot, and slam like to ricochet. Use AirboatGun for a light metal peircing shotgun pellets

SWEP.Primary.MaxAmmo = 440
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_aeolis.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_aeoliselegant" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_aeolis.mdl" -- Worldmodel path
