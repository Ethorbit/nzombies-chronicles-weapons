...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_ak12.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Burst = 1000 -- This is in Rounds Per Minute / RPM

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "AttacKer 24-680"
...
--Range Related
SWEP.Primary.Range = 800 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_ak12.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_ak12.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(4.675, -2.089, 1.425)
SWEP.IronSightsAng = Vector(1.45, -2.685, -0.352)
