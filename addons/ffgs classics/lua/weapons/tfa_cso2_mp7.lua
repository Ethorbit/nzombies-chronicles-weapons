...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_mp7.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip = 185 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
SWEP.Primary.MaxAmmo = 185
...
SWEP.Primary.RangeFalloff = 0.5 -- The percentage of the range the bullet damage starts to mp7l off at.  Set to 0.8, for example, to start mp7ling off after 80% of the range.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_mp7.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_mp7.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.258, -6.24, 3.2)
SWEP.IronSightsAng = Vector(-0.424, 0, -0.569)
--[[INSPECTION]]--
