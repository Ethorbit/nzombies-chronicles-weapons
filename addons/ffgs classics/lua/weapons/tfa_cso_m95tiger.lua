...
SWEP.NZPaPReplacement 	= "tfa_cso_m95ghost"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
function SWEP:NZMaxAmmo()
	...
	self.Owner:SetAmmo(15, "M95_NADE")
