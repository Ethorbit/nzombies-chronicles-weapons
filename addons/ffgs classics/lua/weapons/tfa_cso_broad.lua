...
SWEP.PrintName				= "Broad Divine"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Broad.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_broad.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_broad.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.15, 0, 0.4)
