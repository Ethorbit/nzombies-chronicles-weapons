...
function SWEP:OnPaP()
	...
	self.Secondary.BashEnd = 1.1
	self.Secondary.BashDelay = 0.7
	--self.Secondary.BashDamage = 13000
	self.Secondary.BashLength = 135
	self:ClearStatCache()
end
...
SWEP.Secondary.BashHitSound = "nz/knife/hit_object.wav"
SWEP.Secondary.BashHitSound_Flesh = Sound("BO1Knife.StabZombie")
