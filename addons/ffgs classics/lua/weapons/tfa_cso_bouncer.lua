...
function SWEP:OnPaP()
	...
	self.TracerName = "cso_tra_bouncer_red"
	...
	self.Primary.MaxAmmo = 130
	self:ClearStatCache()
end

-- function SWEP:Reload(...)
-- 	self:ResetSequence(self:LookupSequence("reload_insert"))
...
SWEP.VMPos = Vector(0,0,-2) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.IronSightsPos = Vector(6.71, 0, 1.5)
