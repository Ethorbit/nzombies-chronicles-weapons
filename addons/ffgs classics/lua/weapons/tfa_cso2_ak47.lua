...
--SWEP.NZPaPName				= "Automatic Kalamity-47 80"
SWEP.NZPaPReplacement 	= "tfa_cso2_ak47_gold"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_ak47.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_ak47.mdl" -- Weapon world model path
