...
function SWEP:OnPaP()
	...
	self.SequenceRateOverride = {[ACT_VM_RELOAD] = 1.9, [ACT_VM_RELOAD_EMPTY] = 1.9} --Like above but changes animation length to a target
	self.SequenceRateOverrideScaled = {[ACT_VM_RELOAD] = 1.9, [ACT_VM_RELOAD_EMPTY] = 1.9} --Like above but scales animation length rather than being absolute
	self.ProjectileEntity = "milkor_m32_mgl_nade_pap"
