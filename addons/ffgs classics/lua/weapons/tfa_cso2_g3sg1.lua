...
SWEP.PrintName				= "G3SG-1"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_g3sg1.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Auto-Terrorist Trouble"
...
--Range Related
SWEP.Primary.Range = 1000 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_g3sg1.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_g3sg1.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector( -1.5, -4, -0.5)
...
SWEP.IronSightsPos = Vector(7.349, -2.441, 2.759)
SWEP.IronSightsAng = Vector(-1.637, 0, 0)
--[[INSPECTION]]--
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -6.161, 0) },
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6.733, -7.764, 0) }
}
