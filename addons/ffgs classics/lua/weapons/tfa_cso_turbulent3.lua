...
SWEP.Primary.DefaultClip			= 252				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
function SWEP:OnPaP()
	...
	self.Primary.MaxAmmo = 355
	self.Primary.Damage = 110
	self.Primary.RPM = 1300
	self.Primary.ClipSize = 65
