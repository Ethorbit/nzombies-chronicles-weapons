...
SWEP.PrintName				= "Galil SR"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_galilsniper.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 186.5 -- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Galil SuperRuler"
...
SWEP.Primary.DefaultClip = 355 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
SWEP.Primary.MaxAmmo = 355
...
SWEP.Primary.SpreadIncrement = 1.0 --What percentage of the modifier is added on, per shot.  Example val: 1/3.5
...
--Range Related
SWEP.Primary.Range = 750 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_galilsniper.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_galilsniper.mdl" -- Weapon world model path
