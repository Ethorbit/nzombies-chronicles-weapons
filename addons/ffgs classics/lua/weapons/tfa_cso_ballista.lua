...
SWEP.Primary.Damage		= 61.25					-- Damage, in standard damage points.
...
SWEP.NZPaPReplacement 	= "tfa_cso_magnum_lancer"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
function SWEP:NZMaxAmmo()
    ...
    if SERVER then
		...
		self.Owner:SetAmmo( 4, "BULLET_LANCER" ) 
    end
end
...
SWEP.MoveSpeed = 0.1 --Multiply the player's movespeed by this.
