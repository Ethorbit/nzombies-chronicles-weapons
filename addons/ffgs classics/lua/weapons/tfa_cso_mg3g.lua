...
SWEP.Primary.RPM_Semi				= 1300					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPReplacement 	= "tfa_cso_mg3xmas"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 700				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
