...
SWEP.PrintName				= "DR-200"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_dr200.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Dual Reverter 400"
...
--Range Related
SWEP.Primary.Range = 600 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_dr200.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_dr200.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(11.13, -12, 3.9)
SWEP.IronSightsAng = Vector(1.748, 2.2, 3.496)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.125,-3,0.1)
