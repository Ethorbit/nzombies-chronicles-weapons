...
SWEP.Primary.Damage		= 133					-- Damage, in standard damage points.
...
SWEP.Primary.RPM				= 2900					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 2900					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPName				= "COCAINE MAGMA POT"
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = 230
	self.Primary.MaxAmmo = 2000
end

--Ammo Related

SWEP.Primary.ClipSize			= 500					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 1000				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
