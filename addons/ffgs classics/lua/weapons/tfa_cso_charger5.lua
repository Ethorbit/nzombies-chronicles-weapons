...
SWEP.NZPaPReplacement 	= "tfa_cso_charger7"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Secondary.Ammo = "CHARGER5_BEAM"
...
function SWEP:SecondaryAttack()
    ...
    local fkingLineTrace = util.TraceLine({
        start = bullet.Src,
        endpos = bullet.Dir * 100000,
        filter = self.Owner
    })
        
    local zombies = ents.FindInBox(fkingLineTrace.HitPos - Vector(80, 80, 80), fkingLineTrace.HitPos + Vector(80, 80, 80))
