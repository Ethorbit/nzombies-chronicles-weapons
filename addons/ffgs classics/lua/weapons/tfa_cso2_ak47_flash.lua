...
SWEP.PrintName				= "AK-47 Flash"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.DamageType = bit.bor(DMG_BULLET,DMG_AIRBOAT) -- Damage, in standard damage points.
SWEP.Primary.NumShots = 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = true -- Automatic/Semi Auto
SWEP.Primary.RPM = 600 -- This is in Rounds Per Minute / RPM

-- SWEP.Primary.ExplodeSurface = true
-- SWEP.Primary.ExplosionRadius = 200
-- SWEP.Primary.ExplosionType = "M2Explode"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_ak47_flash.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_ak47_flash.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-2.8, 1.85, -1.377) }
}
...
function SWEP:Deploy( ... )
	...
	timer.Simple(0, function()
		if IsValid(self) and self:VMIV() then
			self:CleanParticles()
			ParticleEffectAttach( "ss_ak47_fire_f", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 3 )
			ParticleEffectAttach( "ss_ak47_fire_f", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 4 )
		end
	end)
	return true
end
