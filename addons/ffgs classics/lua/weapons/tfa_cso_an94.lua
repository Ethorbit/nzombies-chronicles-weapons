...
--Firing related
SWEP.Primary.Sound 			= Sound("AN94.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.DefaultFireMode 	= "2Burst" --Default to auto or whatev
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_an94.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_an94.mdl" -- Worldmodel path
