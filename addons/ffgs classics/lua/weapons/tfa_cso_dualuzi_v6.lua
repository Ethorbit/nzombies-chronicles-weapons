...
SWEP.Primary.DamageHeadshot = 1.9
...
SWEP.NZPaPReplacement 	= "tfa_cso_dualuzi_v6_stock"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 380				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
