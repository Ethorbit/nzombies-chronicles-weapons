...
SWEP.PrintName				= "Unreal Tsunami"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.PenetrationMultiplier	= 40
SWEP.Primary.HullSize = 14
--[[WEAPON HANDLING]]--

--Firing related
SWEP.Primary.Sound 			= Sound("Bow.Charge_Shoot")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 21					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 21					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= true	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName			= "Unreal Tsunami"
...
function SWEP:OnPaP()
	...
	-- self.TracerName = "tra_bow_v6"
	-- self.Primary.RPM = 63
	-- self.Primary.RPM_Semi = 63
	-- self.Primary.MaxAmmo = 45
	-- self.Primary.Spread	= .04
	-- self.Primary.IronAccuracy = .02
	-- self.SequenceRateOverride = {[ACT_VM_RELOAD] = 2, [ACT_VM_RELOAD_EMPTY] = 2, [ACT_VM_RELOAD_SILENCED] = 2} --Like above but changes animation length to a target
	-- self.SequenceRateOverrideScaled = {[ACT_VM_RELOAD] = 2, [ACT_VM_RELOAD_EMPTY] = 2, [ACT_VM_RELOAD_SILENCED] = 2} --Like above but scales animation length rather than being absolute
...
SWEP.SequenceRateOverride = {[ACT_VM_RELOAD] = 2, [ACT_VM_RELOAD_EMPTY] = 2, [ACT_VM_RELOAD_SILENCED] = 2} --Like above but changes animation length to a target
SWEP.SequenceRateOverrideScaled = {[ACT_VM_RELOAD] = 2, [ACT_VM_RELOAD_EMPTY] = 2, [ACT_VM_RELOAD_SILENCED] = 2} --Like above but scales animation length rather than being absolute
