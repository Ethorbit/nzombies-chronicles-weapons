...
SWEP.PrintName				= "Coil Machine Gun"		-- Weapon name (Shown on HUD)
...
function SWEP:OnPaP()
	...
	self.TracerName = "cso_tra_coilmg_pap"
end
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_coilmg.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_coilmg.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_coilmg" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_coilmg" 	--Change to a string of your tracer name.  Can be custom.
