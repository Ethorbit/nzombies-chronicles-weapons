...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_aek971.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Accelerated Enemy Krusher-9711"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_aek971.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_aek971.mdl" -- Weapon world model path
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = self.Primary.Damage * 1.5
...
SWEP.IronSightsPos = Vector(5.54, -10.044, 1.684)
SWEP.IronSightsAng = Vector(0.486, 1.76, 0.783)
...
SWEP.BlowbackVector = Vector(-0.06,-2,0.03) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-3.126, -13.325, 0) }
}
