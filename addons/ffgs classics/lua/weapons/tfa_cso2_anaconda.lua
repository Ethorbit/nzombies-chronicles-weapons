...
SWEP.PrintName				= "Anaconda"		-- Weapon name (Shown on HUD)
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = 400
end

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_anaconda.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_anaconda.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_anaconda.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(4.239, -1.831, 2.5)
SWEP.IronSightsAng = Vector(1.292, -0.086, 0)
--[[INSPECTION]]--
