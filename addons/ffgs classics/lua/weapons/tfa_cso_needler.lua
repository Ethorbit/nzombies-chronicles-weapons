...
--SWEP.Primary.NoPapHead = 20
--SWEP.Primary.PapHead = 40
SWEP.Primary.DamageHeadshot = 20
...
function SWEP:OnPaP()
	...
	self.Primary.DamageHeadshot = 40
end

DEFINE_BASECLASS(SWEP.Base)
function SWEP:Think(...)
	--if (IsValid(self:GetOwner()) and self:GetOwner():HasPerk("deadshot")) then -- Fuck deadshot 2.0 being OP
		--self.Primary.DamageHeadshot = 10
	--else
		-- if (self:HasNZModifier("pap")) then
		-- 	self.Primary.DamageHeadshot = self.Primary.PapHead
		-- else
		-- 	self.Primary.DamageHeadshot = self.Primary.NoPapHead
		-- end
	--end
