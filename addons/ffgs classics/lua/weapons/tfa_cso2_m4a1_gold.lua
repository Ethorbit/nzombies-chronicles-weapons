...
SWEP.Primary.Damage = 155 -- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Midas's Firearm"
...
--Range Related
SWEP.Primary.Range = 500 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m4a1_gold.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m4a1_gold.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.5575, -6.518, 1.169)
SWEP.IronSightsAng = Vector(2.65, 0.1, 1.299)
...
SWEP.BlowbackVector = Vector(-0.00,-2,0.1) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-3.5, -8.311, 0) }
}
