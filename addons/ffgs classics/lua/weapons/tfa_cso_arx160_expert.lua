...
SWEP.PrintName				= "Beretta ARX-160 Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("ARX160.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "ARX"
SWEP.NZPaPReplacement 	= "tfa_cso_skull4"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 215				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
SWEP.Primary.Ammo			= "ar2"					-- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
--Pistol, buckshot, and slam like to ricochet. Use AirboatGun for a light metal peircing shotgun pellets

SWEP.Primary.MaxAmmo = 215
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_arx160_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_arx160_expert.mdl" -- Worldmodel path
...
SWEP.Secondary.IronFOV			= 43					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
