...
SWEP.Primary.RPM_Semi				= 115					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPReplacement 	= "tfa_cso_uts15g"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Ammo Related
SWEP.SequenceRateOverride = {[ACT_VM_RELOAD] = 4, [ACT_VM_RELOAD_EMPTY] = 4} --Like above but changes animation length to a target
SWEP.SequenceRateOverrideScaled = {[ACT_VM_RELOAD] = 4, [ACT_VM_RELOAD_EMPTY] = 4} --Like above but scales animation length rather than being absolute
