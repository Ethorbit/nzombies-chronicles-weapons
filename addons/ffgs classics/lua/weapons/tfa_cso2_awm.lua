...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_awp_tw.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPReplacement 	= "tfa_cso2_awp_ss"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.IronSightsPos = Vector(7.599, 0, 1.48)
