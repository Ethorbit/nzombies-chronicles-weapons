...
function SWEP:OnPaP()
	...
	self.Primary.RPM = 90
	self.Primary.RPM_Semi = 90
	self.SequenceRateOverride = {[ACT_VM_RELOAD] = 2, [ACT_VM_RELOAD_EMPTY] = 2} --Like above but changes animation length to a target
	self.SequenceRateOverrideScaled = {[ACT_VM_RELOAD] = 2, [ACT_VM_RELOAD_EMPTY] = 2} --Like above but scales animation length rather than being absolute
end
