...
function SWEP:OnPaP()
	...
	self.Primary.Damage = 190
	self.Primary.DefaultClip = 650
	self.Primary.ClipSize = 300
...
SWEP.ScopeScale = 1.2 --Scale of the scope overlay
...
SWEP.IronSightsPos = Vector(8, 0, -3.13)
