...
SWEP.SequenceRateOverride = {[ACT_VM_RELOAD] = 2, [ACT_VM_RELOAD_EMPTY] = 2} --Like above but changes animation length to a target
SWEP.SequenceRateOverrideScaled = {[ACT_VM_RELOAD] = 2, [ACT_VM_RELOAD_EMPTY] = 2} --Like above but scales animation length rather than being absolute
...
SWEP.Primary.RPM_Semi				= 460					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

SWEP.Secondary.ClipSize = -1
SWEP.Secondary.DefaultClip = 15
SWEP.Secondary.Ammo = "gatlingex_fire"
...
SWEP.Primary.MaxAmmo = 365
function SWEP:NZMaxAmmo()
	self:SetClip1(self.Primary.ClipSize)
	self.Owner:SetAmmo(15, "gatlingex_fire")
