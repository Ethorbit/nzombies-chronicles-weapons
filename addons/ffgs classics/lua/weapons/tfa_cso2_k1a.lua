...
SWEP.PrintName				= "K1A"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_k1a.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "K1A 24-50 MasterX"
...
SWEP.Primary.DefaultClip = 190 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
SWEP.Primary.MaxAmmo = 190
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_k1a.mdl" --Viewmodel path
...
function SWEP:OnPaP()
	...
	self.Primary.MaxAmmo = 325
	self:ClearStatCache()
end

--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_k1a.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(4.289, -5.956, 1.57)
SWEP.IronSightsAng = Vector(0.259, 0, -8.066)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.0,-2,0.0)
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-7.658, -8.744, 0) }
}
