...
SWEP.PrintName				= "BALROG-I"		-- Weapon name (Shown on HUD)
...
SWEP.AllowIgnite = true
SWEP.IgniteChance = 30
SWEP.IgniteDamage = 20
SWEP.IgniteRadius = 3
...
--Firing related
SWEP.Primary.Sound 			= Sound("BALROG1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "FALLICA-2"	-- What name this weapon should use when Pack-a-Punched.
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = 72
	self.IgniteDamage = 30
	self.Primary.RPM = 625
	self.Primary.RPM_Semi = 625
	self.IgniteChance = 50
end
...
SWEP.Primary.KickDown			= 0.124					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_balrog_1.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_balrog1blue","cso_balrog1poison" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_balrog_1.mdl" -- Worldmodel path
