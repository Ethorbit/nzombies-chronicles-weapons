...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_glock.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Burst = 1200 -- This is in Rounds Per Minute / RPM
...
SWEP.NZPaPName				= "Glock-Clock 36 Ultra"
...
--Range Related
SWEP.Primary.Range = 125 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_glock18.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_glock18.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(0, -11, -6)
SWEP.RunSightsAng = Vector(55, 10, 0)
...
SWEP.IronSightsPos = Vector(5.645, 0, 4.36)
SWEP.IronSightsAng = Vector(-2.346, 5.735, -1.162)
...
SWEP.BlowbackVector = Vector(-0.2,-2,-0.05) --Vector to move bone <or root> relative to bone <or view> orientation.
SWEP.BlowbackCurrentRoot = 0 --Amount of blowback currently, for root
SWEP.BlowbackCurrent = 0 --Amount of blowback currently, for bones
SWEP.BlowbackBoneMods = {
	["CSO2_Glock18_YAGSIL"] = { scale = Vector(1, 1, 1), pos = Vector(0, 1.447, 0), angle = Angle(0, 0, 0) }
...
--Tracer Stuff
SWEP.TracerName 		= nil--Impact 	--Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
function SWEP:glock18loy( ... )
	BaseClass.glock18loy( self, ... )
	timer.Simple(0.01, function()
		if not IsValid(self) then return end
		if not self:VMIV() then return end
		self:CleanParticles()
		ParticleEffectAttach( "ss_glock18_fire_f", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 5 )
		ParticleEffectAttach( "ss_glock18_fire_f", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 6 )
	end)
	return true
end
