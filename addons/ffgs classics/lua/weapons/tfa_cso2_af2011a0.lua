...
SWEP.PrintName				= "AF2011A0"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_af2011a0.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Mustang and Sally's big brother"
SWEP.NZPaPReplacement 	= "tfa_cso2_af2011a1"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_af2011a0.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_af2011a0.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector(-10.242, -5.427, 15.022)
...
SWEP.IronSightsPos = Vector(5.619, -4.034, 0.899)
SWEP.IronSightsAng = Vector(2.775, 0.774, -0.907)
