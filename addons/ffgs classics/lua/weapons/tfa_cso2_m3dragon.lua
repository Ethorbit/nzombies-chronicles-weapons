...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m3dragon.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 55 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 21 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
SWEP.SequenceRateOverride = {[ACT_VM_RELOAD] = 3, [ACT_VM_RELOAD_EMPTY] = 3} --Like above but changes animation length to a target
SWEP.SequenceRateOverrideScaled = {[ACT_VM_RELOAD] = 3, [ACT_VM_RELOAD_EMPTY] = 3} --Like above but scales animation length rather than being absolute
...
SWEP.IronSightsPos = Vector(5.28, 0, 2.299)
