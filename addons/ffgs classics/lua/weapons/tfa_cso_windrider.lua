...
SWEP.Primary.Damage		= 160 * 1.5					-- Damage, in standard damage points.
...
SWEP.NZPaPReplacement 	= "tfa_cso_gunkata"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
