...
SWEP.PrintName				= "Eruption"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPReplacement 	= "tfa_cso_volcanoex"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
