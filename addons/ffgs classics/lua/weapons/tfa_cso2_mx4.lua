...
SWEP.PrintName				= "MX4 Storm"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_mx4.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 44 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = true -- Automatic/Semi Auto
SWEP.Primary.RPM = 835 -- This is in Rounds Per Minute / RPM
...
function SWEP:OnPaP()
	...
	self.Primary.MaxAmmo = 340
end

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Mx8 SharkStorm"
...
SWEP.Primary.RangeFalloff = 0.5 -- The percentage of the range the bullet damage starts to mx4l off at.  Set to 0.8, for example, to start mx4ling off after 80% of the range.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_mx4.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_mx4.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(-1, -3.5, -0.5)
...
SWEP.IronSightsPos = Vector(4.921, -2.494, 1.539)
SWEP.IronSightsAng = Vector(0.851, 0, 0)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.0,-2,0.03)
