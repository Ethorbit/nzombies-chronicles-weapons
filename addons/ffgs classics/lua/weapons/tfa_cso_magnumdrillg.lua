...
SWEP.VMPos = Vector(0,0,-3) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.Secondary.BashDamage = 13000
SWEP.Secondary.BashEnd = 1.4
