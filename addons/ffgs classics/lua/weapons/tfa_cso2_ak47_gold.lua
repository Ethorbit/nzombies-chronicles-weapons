...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_ak47.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 50 * 1.5 -- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Midas's Touch"
SWEP.NZPaPReplacement 	= "tfa_cso2_ak47_flash"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_ak47_gold.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_ak47_gold.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.283, -7.676, 2.131)
SWEP.IronSightsAng = Vector(1.047, -0.152, 3.065)
...
SWEP.BlowbackVector = Vector(-0,-3,0.03) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -4.24, 0) },
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6.988, 7.157, -5.454) },
	["ValveBiped.Bip01_R_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-1.084, -12.599, 0) }
}
