...
function SWEP:Reload(...)
	self.ShockCooldown = CurTime() + 3.3
...
SWEP.NZPaPName				= "Charged 9000 volt gun"
...
SWEP.TracerName 		= "cso_tra_lyc_pap" 	--Change to a string of your tracer name.  Can be custom.
