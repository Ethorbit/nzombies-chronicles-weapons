...
SWEP.PrintName				= "BALROG-V"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_balrog5.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_balrog5.mdl" -- Worldmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_balrog5blue", "cso_balrog5poison" } },
}
