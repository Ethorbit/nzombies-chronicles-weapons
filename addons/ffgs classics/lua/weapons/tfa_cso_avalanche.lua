...
SWEP.PrintName				= "Avalanche"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.SilencedSound = Sound("robotnik_bo1_commando.Silenced") -- This is the sound of the weapon, when silenced.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_avalanche.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_avalanche.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(9.71, 0, 1.13)
