...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_galil.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPReplacement 	= "tfa_cso2_galilsr"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.ove this line.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_galil.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_galil.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(3.69, -3.77, 1.529)
...
SWEP.BlowbackVector = Vector(-0.03,-1.5,0.075)
