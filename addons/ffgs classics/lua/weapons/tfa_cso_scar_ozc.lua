...
SWEP.PrintName				= "SCAR OZ-C"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("ScarC.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "OOF-1000"
SWEP.NZPaPReplacement 	= "tfa_cso_scar_ozd"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_scar_ozc.mdl" --Viewmodel path
...
SWEP.VMAng = Vector(0,0,1) --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_scar_ozc.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/scarozc_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(8.1, -6.4, 3.8)
SWEP.IronSightsAng = Vector(-9.5, 6.5, -1.5)
...
SWEP.MuzzleFlashEffect = "cso_muz_oz" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_oz" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ozscarc")
