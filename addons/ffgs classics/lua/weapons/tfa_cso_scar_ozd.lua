...
SWEP.PrintName				= "SCAR OZ-D"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("ScarD.Fire1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Secondary.Ammo = "SCAR_NADE"
SWEP.Secondary.Ent = "oznade"
...
SWEP.Secondary.Model = "models/weapons/tfa_cso/w_oznade.mdl" --Projectile Model
SWEP.Secondary.Damage = 900 --Grenade Damage
SWEP.Secondary.Velocity = 2000 --Grenade Velocity
SWEP.Secondary.Delay = 0.5 --Delay in seconds
SWEP.Secondary.Sound = Sound("ScarD.Fire2") --Firing sound
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_scar_ozd.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_scar_ozd.mdl" -- same case UHGI;DFSD/
...
function SWEP:NZMaxAmmo()
	...
	self.Owner:SetAmmo( 25, "SCAR_NADE" )  
end
...
SWEP.TracerName 		= "cso_tra_oz_pap" 	--Change to a string of your tracer name.  Can be custom.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ozscard")
