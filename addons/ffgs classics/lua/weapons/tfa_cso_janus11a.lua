...
-- SWEP.NZPaPName				= "DEZZ NUTS" -- Really global? Dead meme as a pap name?
SWEP.NZPaPReplacement 	= "tfa_cso_janus11b"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
