...
EFFECT.Col1 = Color(255, 0, 255) --Color(225,225,225,225)
EFFECT.Col2 = Color(255, 0, 255)
EFFECT.Speed = 8194
...
Draw the effect
-----------------------------------------------------------]]
local lerpedcol = Color(225, 0, 0, 225)
...
render.DrawBeam(startbeampos, endbeampos, 2, 0, 1, lerpedcol)
end
