EFFECT.g_sModelIndexFireball3 = Material("sprites/magicmg_exp2")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("MegicRod.Exp2", 180, 100 )
end
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 28), 0, 28))
