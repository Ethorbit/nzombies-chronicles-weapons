...
local beamcol = table.Copy(Color(255, 0, 0, 255))
...
function EFFECT:Render()
	...
	render.DrawSprite(endPos, 90, 90, Color(255, 0, 0, 255))
	render.SetMaterial(Mat_Beam)
	render.DrawBeam(startPos, endPos, 21, 110 + beamcol.a / 128, endPos:Distance(startPos) / 64 + beamcol.a / 128, beamcol)
end
