...
local Mat_Beam = Material("effects/select_ring")
...
function EFFECT:Render()
	...
	render.DrawSprite(endPos, 12, 12, Color(255, 0, 0, 255))
	render.SetMaterial(Mat_Beam)
	render.DrawBeam(startPos, endPos, 2, 0 + beamcol.a / 128, endPos:Distance(startPos) / 64 + beamcol.a / 128, beamcol)
end
