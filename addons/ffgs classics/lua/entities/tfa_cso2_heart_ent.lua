...
function ENT:Initialize()
	...
	self:SetModel( "models/weapons/tfa_cso2/w_hegrenade_heart_thrown.mdl" )
...
function ENT:Explode()
	...
	ParticleEffect("cso2_mila_hegrenade",self:GetPos(),self:GetAngles(),NULL)
	...
	self:EmitSound("ValentineGrenade.Explode")
	self:Remove()
end
