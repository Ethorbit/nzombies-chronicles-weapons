...
if SERVER then
	...
	function ENT:PhysicsCollide(data, physobj)	
		...
		util.Effect("exp_plasmaexd",fx)
		self:Remove()
	    self.Entity:EmitSound("weapons/tfa_cso/plasmagunexd/exp.wav", 100, 100 )
	end
end
...
function ENT:Draw()
render.SetMaterial(Material("sprites/ef_y20s3plasmaexd2_ball"))
