ENT.Type 			= "anim"
ENT.Base 			= "base_anim"
ENT.PrintName		= "Shooting Star Nade"
ENT.Category		= "None"
...
if SERVER then
	...
	function ENT:Initialize()
		...
		self:SetMaterial( "models/weapons/tfa_cso/shooting_star/bullet" )
		self:SetHealth(1)
	...
	function ENT:PhysicsCollide(data, physobj)
	    ...
	    self.Entity:EmitSound("weapons/tfa_cso/shooting_star/exp.wav", 120, 120 )
		self:Remove()
	end
end
