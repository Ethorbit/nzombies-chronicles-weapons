...
TFA.AddWeaponSound( "CoilMG_Summer.Fire", "weapons/tfa_cso/summersplash/coilmg_fire.wav", false, "^" )
local hookName = "cso_coilmgsummer" -- hook ID for patcher, make sure it's set to something unique!

local patchTbl = {
	["tfa_cso_coilmg"] = { -- class of weapon you want to patch skins in
		[1] = { -- SWEP.Attachments table index/category
			"tfa_cso_coilmgsummer", -- list of attachment IDs (lua/tfa/att/<attachment id>.lua) you want to patch in, comma-separated
		},
	},
}
