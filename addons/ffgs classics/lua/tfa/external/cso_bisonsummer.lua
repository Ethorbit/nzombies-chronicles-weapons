...
TFA.AddWeaponSound( "Bizon_Summer.Fire", "weapons/tfa_cso/summersplash/bizon_fire.wav", false, "^" )
local hookName = "cso_bisonsummer" -- hook ID for patcher, make sure it's set to something unique!

local patchTbl = {
	["tfa_cso_bison"] = { -- class of weapon you want to patch skins in
		[1] = { -- SWEP.Attachments table index/category
			"tfa_cso_bisonsummer", -- list of attachment IDs (lua/tfa/att/<attachment id>.lua) you want to patch in, comma-separated
		},
	},
}
