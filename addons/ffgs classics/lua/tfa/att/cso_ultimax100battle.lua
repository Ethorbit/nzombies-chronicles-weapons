...
ATTACHMENT.WeaponTable = {
	...
	["Spread"] = function( wep, stat ) return stat -0.005 end,
	["IronAccuracy"] = function( wep, stat ) return stat -0.005 end,
	["KickUp"] = function(wep, stat) return stat -0.05 end,
	["KickDown"] = function(wep, stat) return stat -0.05 end,
	["KickHorizontal"] = function(wep, stat) return stat -0.05 end,
