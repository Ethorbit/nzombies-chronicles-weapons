...
ATTACHMENT.Description = {TFA.AttachmentColors["+"],"+6 Damage", TFA.AttachmentColors["-"],"+10 Recoil", TFA.AttachmentColors["-"],"-1 Accuracy"}
...
ATTACHMENT.WeaponTable = {
	...
	["KickDown"] = function(wep, stat) return stat +0.10 end,
	["KickHorizontal"] = function(wep, stat) return stat +0.10 end,
	}
}
