if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_ar15")
end
...
SWEP.PrintName						= "Clot Slaughter M635"											-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "Clot Slaughter M635"								-- Pack-a-Punch Name
...
--[[WEAPON HANDLING]]--
local snd1 = Sound("TFA_KF2_AR15.1")
local snd2 = Sound("TFA_KF2_AR15.2")
local snd3 = Sound("TFA_KF2_AR15.3")
...
SWEP.Primary.RPM_Semi 				= 1350 											-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.DefaultClip 			= 540 											-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_ar15.mdl"			-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(4.6, 4, -1.6)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_ar15.mdl" 			-- Weapon world model path
