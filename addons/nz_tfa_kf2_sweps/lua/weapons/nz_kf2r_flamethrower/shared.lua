...
SWEP.NZPaPReplacement				= "nz_kf2r_flamethrower_pap"					-- Pack-a-Punch Replacement
...
SWEP.Primary.RPM 					= 570 											-- This is in Rounds Per Minute / RPM
                ...
                if (tr.Entity != self.Owner) then -- Nothing's obstructing the zombie
                    ...
                    if (ent.m2burnmeagainin == nil or CurTime() > ent.m2burnmeagainin) then
                        ...
                        if (self:HasNZModifier("pap")) then
                            initialdmg:SetDamage(15)
                        else
                            initialdmg:SetDamage(5)
                        end
