if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_aa12")
end
...
SWEP.PrintName						= "AA-24 Z35 MUR53R"							-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "AA-24 Z35 MUR53R"							-- Pack-a-Punch Name
SWEP.Slot							= 3												-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos						= 73											-- Position in the slot
SWEP.AutoSwitchTo					= true											-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom					= true											-- Auto switch from if you pick up a better weapon
SWEP.Weight							= 30											-- This controls how "good" the weapon is for autopickup.
SWEP.Type 							= "Automatic Shotgun"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound 					= Sound("TFA_KF2_AA12.1")						-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound			= ""											-- This is the sound of the weapon, when you shoot and weapon is slienced
SWEP.Primary.PenetrationMultiplier 	= 1 											-- Change the amount of something this gun can penetrate through
SWEP.Primary.Damage 				= 113											-- Damage, in standard damage points.
...
SWEP.Primary.NumShots 				= 24 											-- The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
--Ammo Related
SWEP.Primary.ClipSize 				= 38 											-- This is the size of a clip
SWEP.Primary.DefaultClip 			= 308 											-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Firing Cone Related
SWEP.Primary.Spread 				= .095										 	-- This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_aa12.mdl"			-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(-13, -20, 3.2)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_aa12.mdl" 			-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(-3, -26, 3.2) 							-- Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng 					= Vector(-5, 55, 10)  							-- Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos 					= Vector(-17.681, -14, 4.4)
SWEP.IronSightsAng 					= Vector(0.4, 0, 0)

--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(-6.3, -22, 2)
SWEP.InspectAng 					= Vector(14.4, 25.4, 12)
