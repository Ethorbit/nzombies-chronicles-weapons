if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_doublebarrel")
end
...
SWEP.PrintName						= "12-Gauge Boomstick"							-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "12-Gauge Boomstick"							-- Pack-a-Punch Name
SWEP.Slot							= 3												-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos						= 73											-- Position in the slot
SWEP.AutoSwitchTo					= true											-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom					= true											-- Auto switch from if you pick up a better weapon
SWEP.Weight							= 30											-- This controls how "good" the weapon is for autopickup.
SWEP.Type 							= "Double Barrel Shotgun"

--[[WEAPON HANDLING]]--
local snd1 = Sound("TFA_KF2_DB.1")
local snd2 = Sound("TFA_KF2_DB.2")
local snd3 = Sound("TFA_KF2_DB.3")
...
SWEP.Primary.Damage 				= 168											-- Damage, in standard damage points.
SWEP.Primary.DamageHeadshot			= 2.75
...
SWEP.Primary.RPM 					= 1750 											-- This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_doublebarrel.mdl"			-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(4.6, 4, -3.1)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_doublebarrel.mdl" 	-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(4, -.6, -2) 							-- Change this, using SWEP Creation Kit preferably
