...
SWEP.PrintName						= "HMTech-301 Shotgun"							-- Weapon name (Shown on HUD)
SWEP.NZPaPReplacement				= "nz_kf2r_medic_shotgun_pap"					-- Pack-a-Punch Replacement
...
SWEP.Primary.Damage 				= 63												-- Damage, in standard damage points.
SWEP.Primary.DamageHeadshot			= 1.8
