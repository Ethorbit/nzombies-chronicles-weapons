...
SWEP.PrintName						= "SCAR-D Fleshpound"							-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "SCAR-D Fleshpound"							-- Pack-a-Punch Name
...
local snd2 = Sound("TFA_KF2_SCAR.2")
local snd3 = Sound("TFA_KF2_SCAR.3")
...
SWEP.Primary.Damage 				= 118 											-- Damage, in standard damage points.
...
SWEP.Primary.RPM 					= 1106 											-- This is in Rounds Per Minute / RPM
...
SWEP.VMPos 							= Vector(4.6, 5, -1.6)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[2] = etc.
--}
SWEP.HoldType = "smg" 																-- This is how others view you carrying the weapon. Options include: normal melee melee2 fist knife smg ar2 pistol rpg physgun grenade shotgun crossbow slam passive. You're mostly going to use ar2, smg, shotgun or pistol. rpg and crossbow make for good sniper rifles
SWEP.Offset = {
        Pos = {
        Up = -1.5,
        Right = 0.3,
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(3, 1.6, -1) 							-- Change this, using SWEP Creation Kit preferably
