...
SWEP.PrintName						= "HANVolt-201 SMG"								-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "HANVolt-201 SMG"								-- Pack-a-Punch Name
...
SWEP.Primary.Damage 				= 101 											-- Damage, in standard damage points.
...
SWEP.Primary.RPM_Semi 				= 1020 											-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
