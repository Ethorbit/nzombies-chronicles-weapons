...
SWEP.Category						= "NZ KF2 Remake PAP" 								-- The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName						= "HANVolt-101 Pistol"							-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "HANVolt-101 Pistol"							-- Pack-a-Punch Name
