if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_medicshotgun")
end
...
SWEP.PrintName						= "HANVolt-301 Shotgun"							-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "HANVolt-301 Shotgun"							-- Pack-a-Punch Name
SWEP.Slot							= 3												-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos						= 73											-- Position in the slot
SWEP.AutoSwitchTo					= true											-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom					= true											-- Auto switch from if you pick up a better weapon
SWEP.Weight							= 30											-- This controls how "good" the weapon is for autopickup.
SWEP.Type 							= "Medic Shotgun"

--[[WEAPON HANDLING]]--
local snd1 = Sound("TFA_KF2_MEDICSG.1")
local snd2 = Sound("TFA_KF2_MEDICSG.2")
local snd3 = Sound("TFA_KF2_MEDICSG.3")
...
SWEP.Primary.Damage 				= 126												-- Damage, in standard damage points.
...
--Ammo Related
SWEP.Primary.ClipSize 				= 18 											-- This is the size of a clip
SWEP.Primary.DefaultClip 			= 216 											-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
SWEP.Primary.Ammo 					= "kf2r_shotgun" 								-- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--Recoil Related
SWEP.Primary.KickUp 				= 3.25 											-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown 				= 2.25 											-- This is the maximum downwards recoil (skeet)
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_medicshotgun.mdl"			-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(4.6, 6, -1.6)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_medicshotgun.mdl" 	-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(4, 2.6, -1) 							-- Change this, using SWEP Creation Kit preferably
...
--Tracer Stuff	
SWEP.TracerName 					= "tfa_bt_shotgun" 								-- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
