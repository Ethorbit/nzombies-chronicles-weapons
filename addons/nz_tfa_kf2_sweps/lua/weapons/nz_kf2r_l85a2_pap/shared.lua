...
SWEP.PrintName						= "Commando Enfield SA80"						-- Weapon name (Shown on HUD)	
SWEP.NZPaPName						= "Commando Enfield SA80"						-- Pack-a-Punch Name
...
local snd2 = Sound("TFA_KF2_L85A2.2")
local snd3 = Sound("TFA_KF2_L85A2.3")
...
SWEP.Primary.Damage 				= 116 											-- Damage, in standard damage points.
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(5, -.6, -1) 							-- Change this, using SWEP Creation Kit preferably
...
--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(16, -.8, -1)
SWEP.InspectAng 					= Vector(15.5, 45, 16)
