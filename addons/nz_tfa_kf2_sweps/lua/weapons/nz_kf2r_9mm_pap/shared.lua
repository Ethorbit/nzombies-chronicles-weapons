if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_9mm")
end
...
SWEP.PrintName						= "K.I.A 92G Elite I-V"						-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "K.I.A 92G Elite I-V"						-- Pack-a-Punch Name
...
SWEP.Primary.RPM 					= 840 											-- This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_9mm.mdl"			-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(4.6, 6.5, -1.6)						-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_9mm.mdl" 			-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(2.6, -.6, -6) 							-- Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos 					= Vector(0 , 7 ,0)
SWEP.IronSightsAng 					= Vector(0 , 0 ,0)

--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(11, -.8, -6)
SWEP.InspectAng 					= Vector(40.5, 35, 25)
