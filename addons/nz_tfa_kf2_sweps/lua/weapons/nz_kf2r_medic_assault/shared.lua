...
SWEP.PrintName						= "HMTech-401 Assault"							-- Weapon name (Shown on HUD)
SWEP.NZPaPReplacement				= "nz_kf2r_medic_assault_pap"					-- Pack-a-Punch Replacement
...
SWEP.Primary.RPM_Semi 				= 740 											-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
