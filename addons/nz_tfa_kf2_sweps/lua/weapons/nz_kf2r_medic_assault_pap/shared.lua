if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_medicassault")
end
...
SWEP.PrintName						= "HANVolt-401 Assault"							-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "HANVolt-401 Assault"							-- Pack-a-Punch Name
SWEP.Slot							= 2												-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos						= 73											-- Position in the slot
SWEP.AutoSwitchTo					= true											-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom					= true											-- Auto switch from if you pick up a better weapon
SWEP.Weight							= 30											-- This controls how "good" the weapon is for autopickup.
SWEP.Type 							= "Medic Assault Rifle"

--[[WEAPON HANDLING]]--
local snd1 = Sound("TFA_KF2_MEDICAR.1")
local snd2 = Sound("TFA_KF2_MEDICAR.2")
local snd3 = Sound("TFA_KF2_MEDICAR.3")
local snd3 = Sound("TFA_KF2_MEDICAR.4")
...
SWEP.Primary.Damage 				= 98											-- Damage, in standard damage points.
...
SWEP.Primary.RPM 					= 1240 											-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi 				= 1480 											-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
--Ammo Related
SWEP.Primary.ClipSize 				= 54 											-- This is the size of a clip
SWEP.Primary.DefaultClip 			= 432 											-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_medicassault.mdl"	-- Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_medicassault.mdl" 	-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(3, 2.6, -1) 							-- Change this, using SWEP Creation Kit preferably
