if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_mb500")
end
...
SWEP.PrintName						= "Gorefiend M500"								-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "Gorefiend M500"								-- Pack-a-Punch Name
SWEP.Slot							= 3												-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos						= 73											-- Position in the slot
SWEP.AutoSwitchTo					= true											-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom					= true											-- Auto switch from if you pick up a better weapon
SWEP.Weight							= 30											-- This controls how "good" the weapon is for autopickup.
SWEP.Type 							= "Pump Shotgun"

--[[WEAPON HANDLING]]--
local snd1 = Sound("TFA_KF2_MB500.1")
local snd2 = Sound("TFA_KF2_MB500.2")
...
SWEP.Primary.Damage 				= 114											-- Damage, in standard damage points.
SWEP.Primary.DamageHeadshot			= 2.35
SWEP.Primary.DamageTypeHandled 		= true 											-- true will handle damagetype in base
SWEP.Primary.DamageType 			= nil 											-- See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
SWEP.Primary.Force 					= nil 											-- Force value, leave nil to autocalc
SWEP.Primary.Knockback 				= nil 											-- Autodetected if nil; this is the velocity kickback
SWEP.Primary.HullSize 				= 0 											-- Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
SWEP.Primary.NumShots 				= 22											-- The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
--Recoil Related
SWEP.Primary.KickUp 				= 4.25 											-- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_mb500.mdl"			-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(3.599, 6, -2.4)						-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_mb500.mdl" 			-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(5, 1.6, -1) 							-- Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng 					= Vector(-15.4, 40, -7.7) 						-- Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos 					= Vector(-0.08, 8, 0.039)
SWEP.IronSightsAng 					= Vector(0, 0, 0)

--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(9, 4.8, -2)
