if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_medicsmg")
end
...
SWEP.PrintName						= "HMTech-201 SMG"								-- Weapon name (Shown on HUD)
SWEP.NZPaPReplacement				= "nz_kf2r_medic_smg_pap"							-- Pack-a-Punch Replacement
SWEP.Slot							= 2												-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos						= 73											-- Position in the slot
SWEP.AutoSwitchTo					= true											-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom					= true											-- Auto switch from if you pick up a better weapon
SWEP.Weight							= 30											-- This controls how "good" the weapon is for autopickup.
SWEP.Type 							= "Medic SubMachine Gun"

--[[WEAPON HANDLING]]--
local snd1 = Sound("TFA_KF2_MEDICSMG.1")
local snd2 = Sound("TFA_KF2_MEDICSMG.2")
local snd3 = Sound("TFA_KF2_MEDICSMG.3")
local snd3 = Sound("TFA_KF2_MEDICSMG.4")
...
SWEP.Primary.SoundTable[4]=snd4
SWEP.Primary.SilencedSound			= ""											-- This is the sound of the weapon, when you shoot and weapon is slienced
SWEP.Primary.PenetrationMultiplier 	= 1 											-- Change the amount of something this gun can penetrate through
SWEP.Primary.Damage 				= 51 											-- Damage, in standard damage points.
SWEP.Primary.DamageHeadshot			= 1.65
...
SWEP.Primary.RPM_Semi 				= 820 											-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_medicsmg.mdl"		-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(4.6, 8, -1.6)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_medicsmg.mdl" 		-- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(3, 4.6, -1) 							-- Change this, using SWEP Creation Kit preferably
...
--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(12, 5.8, -1)
