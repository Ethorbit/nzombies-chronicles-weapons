if ( CLIENT ) then
SWEP.WepSelectIcon 					= surface.GetTextureID("vgui/hud/tfa_kf2_medicpist")
end
SWEP.Base							= "tfa_gun_base"								-- Swep base
SWEP.Category						= "NZ KF2 Remake" 								-- The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName						= "HMTech-101 Pistol"							-- Weapon name (Shown on HUD)
SWEP.NZPaPReplacement				= "nz_kf2r_medic_pistol_pap"					-- Pack-a-Punch Replacement
SWEP.Slot							= 1												-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos						= 73											-- Position in the slot
SWEP.AutoSwitchTo					= true											-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom					= true											-- Auto switch from if you pick up a better weapon
SWEP.Weight							= 30											-- This controls how "good" the weapon is for autopickup.
SWEP.Type 							= "Medic Pistol"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound					= Sound("TFA_KF2_MEDIPISTOL.1")
...
SWEP.Primary.Ammo 					= "kf2r_pistol" 								-- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--	
SWEP.ViewModel						= "models/weapons/kf2/tfa_c_medicpistol.mdl"	-- Viewmodel path
SWEP.ViewModelFOV					= 70											-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip					= false											-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands		 				= true 											-- Use gmod c_arms system.
SWEP.VMPos 							= Vector(4.6, 12, -1.6)							-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel						= "models/weapons/kf2/tfa_w_medicpistol.mdl"	-- Weapon world model path
SWEP.Bodygroups_W = nil --{
--[0] = 1,
--[1] = 4,
--[2] = etc.
--}
SWEP.HoldType = "revolver" 															-- This is how others view you carrying the weapon. Options include: normal melee melee2 fist knife smg ar2 pistol rpg physgun grenade shotgun crossbow slam passive. You're mostly going to use ar2, smg, shotgun or pistol. rpg and crossbow make for good sniper rifles
SWEP.Offset = {
        Pos = {
        Up = -0.2,
        Right = 1,
...
--[[SPRINTING]]--
SWEP.RunSightsPos 					= Vector(2.6, 4.6, -6) 							-- Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng 					= Vector(34, -5, -10)  							-- Change this, using SWEP Creation Kit preferably
...
--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(14, .8, -5)
SWEP.InspectAng 					= Vector(50.5, 35, 36)
...
--Tracer Stuff	
SWEP.TracerName 					= "tfa_bt_pistol" 								-- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
SWEP.VElements = {
	["hud2"] = { type = "Quad", bone = "RW_Sight", rel = "", pos = Vector(-1.2, 0, 0.64), angle = Angle(180, 90, -90), size = 0.002, draw_func = function( weapon )
		if weapon:Clip1() > 5 then
			draw.SimpleText("00" , "sight_holo_b", -60, 30, Color(30,30,30,155), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP)
		else
			draw.SimpleText("00" , "sight_holo_b", -60, 30, Color(255,0,0,155), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP)
		end
		draw.SimpleText(weapon:Clip1(), "sight_holo", -60, 30, Color(255,255,255,255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP)
		if weapon:Clip1() < 1 then
			draw.SimpleText("REQUIRES RELOADING", "sight_holo_rb",0, -170, Color(30,30,30,155), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
			draw.SimpleText("REQUIRES RELOADING", "sight_holo_r",0, -170, Color(255,255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
		end
		if weapon.Primary.Automatic then
			draw.SimpleText("Auto", "sight_holo_rb",100, 65, Color(30,30,30,155), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
			draw.SimpleText("Auto", "sight_holo_r",100, 65, Color(255,255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
		else
			draw.SimpleText("Semi", "sight_holo_rb",100, 65, Color(30,30,30,155), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
			draw.SimpleText("Semi", "sight_holo_r",100, 65, Color(255,255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
		end
	end	},
}