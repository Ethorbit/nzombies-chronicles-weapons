...
SWEP.PrintName						= "Supportive Super 90"							-- Weapon name (Shown on HUD)
SWEP.NZPaPName						= "Supportive Super 90"							-- Pack-a-Punch Name
...
SWEP.Primary.DefaultClip 			= 144 											-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.VMPos 							= Vector(3.599, 7, -2.4)						-- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[INSPECTION]]--
SWEP.InspectPos 					= Vector(11.255, 7.8, -1)
