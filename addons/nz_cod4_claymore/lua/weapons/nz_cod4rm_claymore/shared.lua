...
SWEP.Author			= "Hoff & Krazy"
SWEP.Instructions	= "Place these bad bois around to get rid of those pests"
...
SWEP.ViewModel			= "models/krazy/cod4rm/claymore_v.mdl"
SWEP.WorldModel			= "models/krazy/cod4rm/claymore_w.mdl"
...
function SWEP:DeployShield()
	timer.Simple(0.4,function()
		...
		local ent = ents.Create("ent_nz_cod4rm_claymore")
