...
SWEP.NZPaPName			= "Namvet's Fury"		-- Weapon name (Shown on HUD)
SWEP.PrintName			= "Namvet's Fury"
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_L4D1_M16.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_L4D1_UZI.S") -- This is the sound of the weapon, when you shoot.

SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 145 -- Damage, in standard damage points.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/wick/weapons/l4d1/c_rifle.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/wick/weapons/l4d1/w_rifle.mdl" --Wmodel path
SWEP.Bodygroups_W = {
...
SWEP.SprintAnimation = {
	["loop"] = {
		...
		["value"] = "rifle_run", --Number for act, String/Number for sequence
		["is_idle"] = true,
		["transition"] = true
	},	
}
...
SWEP.WalkAnimation = { 
	["loop"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, --Sequence or act
		["value"] = "rifle_walk", --Number for act, String/Number for sequence
		["is_idle"] = true,
		["transition"] = true
	},
}
...
SWEP.IronSightsPos = Vector(-8.76, 0, 3.559)
SWEP.IronSightsAng = Vector(-1.741, -3.6, -1.818)

SWEP.IronSightsPos_Kobra =  Vector(-8.761, 0, 2.039)
SWEP.IronSightsAng_Kobra = Vector(-0.498, -3.36, -1.818)

SWEP.IronSightsPos_ACOG = Vector(-2.596, -2, 0.645)
SWEP.IronSightsAng_ACOG = Vector(0, 0, 0)
SWEP.IronSightsPos_GL = Vector(-1, -1, 0.5)
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0, type = "sound", value = Sound("TFA_L4D1_RIFLE.DRAW")},
	},
	[ACT_VM_HOLSTER] = {
		{time = 0, type = "sound", value = Sound("TFA_L4D1_RIFLE.DRAW")},
	},
	[ACT_VM_DRAW_DEPLOYED] = {
		{time = 0, type = "sound", value = Sound("TFA_L4D1_RIFLE.DRAW")},
		{time = 26 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.CLIPIN")},
		{time = 32 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.CLIPLOCKED")},
		{time = 48 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.SIDEBACK")},
		{time = 62 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.SIDEFORWARD")},
		{time = 82 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.FULLAUTO")},
		{time = 120 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.READY")},
	},
	[ACT_VM_RELOAD] = {
		{time = 1 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.HELPHANDEX")},
		{time = 7 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.CLIPOUT")},
		{time = 35 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.CLIPIN")},
		{time = 39 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.CLIPLOCKED")}
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 1 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.HELPHANDEX")},
		{time = 7 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.CLIPOUT")},
		{time = 35 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.CLIPIN")},
		{time = 39 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.CLIPLOCKED")},
		{time = 54 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.FULLAUTO")}
	},
	[ACT_VM_FIREMODE] = {
		{time = 1 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.HELPHANDEX")},
		{time = 15 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.READY")},
	},
	[ACT_VM_FIDGET] = {
		{time = 1 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.HELPHANDEX")},
		{time = 28 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.FULLAUTO")},
		{time = 62 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.READY")}
	}
}
--[[ATTACHMENTS]]--
...
SWEP.VElements = {
	["l4d_sil"] = { type = "Model", model = "models/wick/weapons/l4d1/att_silencer.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(0.214, -3.672, 32.527), angle = Angle(90, 90, 3.506), size = Vector(0.711, 0.711, 0.711), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["l4d_laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(1.6, -3.458, 24.875), angle = Angle(90, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["l4d_beam"] = { type = "Model", model = "models/wick/weapons/l4d1/light.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(1.598, -3.455, 20.954), angle = Angle(90, 90, 90), size = Vector(1.156, 1.156, 1.156), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} }
}

SWEP.WElements = {
	["l4d_laser"] = { type = "Model", model = "models/wick/weapons/l4d1/light.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(19.444, 1.993, -6.974), angle = Angle(-9.875, 1.078, 105.791), size = Vector(1.047, 1.047, 1.047), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, active = false, bodygroup = {} },
	["l4d_sil"] = { type = "Model", model = "models/wick/weapons/l4d1/att_silencer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(28.565, 0.476, -8.752), angle = Angle(-11.141, 2.059, 5.744), size = Vector(0.769, 0.769, 0.769), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, active = false, bodygroup = {} }
}
