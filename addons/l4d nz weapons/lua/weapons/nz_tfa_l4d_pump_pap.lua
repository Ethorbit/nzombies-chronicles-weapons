...
SWEP.NZPaPName			= "Rolling Biker"		-- Weapon name (Shown on HUD)
SWEP.PrintName			= "Rolling Biker"
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_L4D1_PUMP.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Displayed = 80 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.DefaultClip = SWEP.Primary.ClipSize * 12 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/wick/weapons/l4d1/c_pumpshotgun.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/wick/weapons/l4d1/w_pumpshotgun.mdl" --Wmodel path
SWEP.Bodygroups_W = {
...
SWEP.SprintAnimation = {
	["loop"] = {
		...
		["value"] = "shotgun_run", --Number for act, String/Number for sequence
		["is_idle"] = true
	},	
}
...
SWEP.WalkAnimation = { 
	["loop"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, --Sequence or act
		["value"] = "shotgun_walk", --Number for act, String/Number for sequence
		["is_idle"] = true
	},
}
--[[IRONSIGHTS]]--
...
SWEP.IronSightsPos = Vector(-5.56, 0, 3.039)
SWEP.IronSightsAng = Vector(-1.257, -3.26, 0.428)
SWEP.IronSightsPos_RDS = Vector(-2.931, -2, 0.5)
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0, type = "sound", value = Sound("TFA_L4D1_PUMP.DRAW")}
	},
	...
	[ACT_SHOTGUN_RELOAD_START] = {
		{time = 1 / 30, type = "sound", value = Sound("TFA_L4D1_PUMP.HELPHANDEX")},
	},
	[ACT_VM_RELOAD] = {
		{time = 4 / 30, type = "sound", value = Sound("TFA_L4D1_PUMP.SHELL")}
	},
	[ACT_SHOTGUN_RELOAD_FINISH] = {
		{time = 5 / 30, type = "sound", value = Sound("TFA_L4D1_PUMP.HELPHANDRET")},
	},
	[ACT_VM_PRIMARYATTACK] = {
		{time = 12 / 30, type = "lua", value = function(self) self:EventShell() end, client = true, server = true}
	}
}
--[[ATTACHMENTS]]--

SWEP.VElements = {
	["l4d_laser"] = { type = "Model", model = "models/wick/weapons/l4d1/light.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(0.16, -1.681, 28.065), angle = Angle(90, 0, 180), size = Vector(0.855, 0.855, 0.855), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["l4d_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(0.086, -1.67, 29.483), angle = Angle(90, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} }
}

SWEP.WElements = {
	["l4d_laser"] = { type = "Model", model = "models/wick/weapons/l4d1/light.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.068, 0, -5.606), angle = Angle(-10.219, 0, 0), size = Vector(0.745, 0.745, 0.745), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", active = false, skin = 0, bodygroup = {} }
}
...
SWEP.SequenceRateOverride = {
	...
	[ACT_SHOTGUN_RELOAD_START] = 2,
	[ACT_SHOTGUN_RELOAD_FINISH] = 2
	}
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -24.598, 180) },
