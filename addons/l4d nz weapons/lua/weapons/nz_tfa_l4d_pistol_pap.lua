...
SWEP.Author				= "WicekdRabbit" --Author Tooltip
...
SWEP.NZPaPName			= "SAM-1911"		-- Weapon name (Shown on HUD)
SWEP.PrintName			= "SAM-1911"
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_L4D1_PISTOL.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_L4D1_UZI.S") -- This is the sound of the weapon, when you shoot.

SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 92 -- Damage, in standard damage points.
...
SWEP.Primary.DryFireDelay = 0.001 -- How long you have to wait after firing your last shot before a dryfire animation can play.  Leave nil for full empty attack length.  Can also use SWEP.StatusLength[ ACT_VM_BLABLA ]
...
--[[VIEWMODEL]]--
SWEP.ViewModel = "models/wick/weapons/l4d1/c_pistol.mdl"
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/wick/weapons/l4d1/w_pistol.mdl" -- Weapon world model path
SWEP.Bodygroups_W = {
...
SWEP.SprintAnimation = {
	["loop"] = {
		...
		["value"] = "pistol_run", --Number for act, String/Number for sequence
		["is_idle"] = true
	},	
}
...
SWEP.WalkAnimation = { 
	["loop"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, --Sequence or act
		["value"] = "pistol_walk", --Number for act, String/Number for sequence
		["is_idle"] = true
	},
}
--[[IRONSIGHTS]]--
...
SWEP.IronSightsPos = Vector(-8.16, 0, 3.88)
SWEP.IronSightsAng = Vector(0.386, -4.849, 0)
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0, type = "sound", value = Sound("TFA_L4D1_PISTOL.DRAW")},
	},
	[ACT_VM_HOLSTER] = {
		{time = 0, type = "sound", value = Sound("TFA_L4D1_PISTOL.DRAW")},
	},
	[ACT_VM_RELOAD] = {
		{time = 0 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.HELPHANDEX")},
		{time = 6 / 30, type = "sound", value = Sound("TFA_L4D1_PISTOL.CLIPOUT")},
		{time = 32 / 30, type = "sound", value = Sound("TFA_L4D1_PISTOL.CLIPIN")},
		{time = 42 / 30, type = "sound", value = Sound("TFA_L4D1_PISTOL.CLIPLOCKED")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 30, type = "sound", value = Sound("TFA_L4D1_RIFLE.HELPHANDEX")},
		{time = 6 / 30, type = "sound", value = Sound("TFA_L4D1_PISTOL.CLIPOUT")},
		{time = 32 / 30, type = "sound", value = Sound("TFA_L4D1_PISTOL.CLIPIN")},
		{time = 42 / 30, type = "sound", value = Sound("TFA_L4D1_PISTOL.CLIPLOCKED")},
		{time = 64 / 30, type = "sound", value = Sound("TFA_L4D1_PISTOL.SLIDE")},
	}
}
--[[ATTACHMENTS]]--
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_R_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 179.837) },
...
SWEP.VElements = {
	["l4d_sil"] = { type = "Model", model = "models/wick/weapons/l4d1/att_silencer.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(0.079, -1.803, 8.866), angle = Angle(90, 90, -3.914), size = Vector(0.407, 0.407, 0.407), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["l4d_laser"] = { type = "Model", model = "models/wick/weapons/l4d1/laser.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(0.029, -0.659, 5.278), angle = Angle(0, 0, -90), size = Vector(0.944, 0.944, 0.944), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["l4d_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.weapon_bone", rel = "", pos = Vector(0, -0.412, 6), angle = Angle(90, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} }
}
