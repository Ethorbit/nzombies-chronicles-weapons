...
local zoom = 8 --Your desired scope zoom
...
ATTACHMENT.Icon = "entities/mw2_thermal.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "Thermal"

ATTACHMENT.WeaponTable = {
	["VElements"] = {
		["mw2_thermal_rtcircle"] = {
			["active"] = true
		},
		["original_rtcircle"] = {
			["active"] = false
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_TH or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_TH or val, true end,
		["Primary"] = {
