...
SWEP.PrintName								= "Scenic Phoenix"
SWEP.NZPaPName								= "Scenic Phoenix"
SWEP.Slot									= 3
SWEP.SlotPos								= 54
SWEP.DrawAmmo								= true
...
SWEP.Primary.Spread							= .011
SWEP.Primary.IronAccuracy 					= .00085
