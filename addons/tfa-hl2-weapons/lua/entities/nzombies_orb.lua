...
if SERVER then
    ...
    function ENT:Initialize()
        ...
        util.SpriteTrail(self, 0, Color(255, 255, 255), false, 14, 0, 0.3, 1 / 10 * 0.5, "trails/plasma")
    ...
    function ENT:PhysicsCollide(colData, collider)
        if (colData.HitEntity:IsWorld()) then
            ...
            if (self.Bounces >= self.MaxBounces) then
                ...
                effects.BeamRingPoint(self:GetPos(), 0.5, 0, 1024, 64, 0, Color(255, 255, 255))
                self:Remove()
            else
                effects.BeamRingPoint(self:GetPos(), 0.1, 0, 54, 15, 0, Color(255, 255, 255))
