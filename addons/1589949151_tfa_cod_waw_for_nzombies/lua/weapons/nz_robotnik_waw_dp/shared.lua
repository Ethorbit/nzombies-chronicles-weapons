...
SWEP.Primary.RPM			= 569			-- This is in Rounds Per Minute
...
SWEP.SightsPos = Vector(-3.668, 0.039, 2.5)
SWEP.SightsAng = Vector(-1.3, -0.13, 0)
SWEP.RunSightsPos = Vector (2, -4, -6)
SWEP.RunSightsAng = Vector (10, 50, -15)
SWEP.InspectPos = Vector(4, -5.5, -4)
SWEP.InspectAng = Vector(10, 45, -15)
SWEP.VMPos = Vector(0.5, 1, -0.9)
