...
function SWEP:OnPaP()
    ...
    self.Primary.Damage = NZCoDDMG(150)
...
SWEP.SightsPos = Vector(-3.12, 2.2, 1.32)
SWEP.SightsAng = Vector(1.6, -1.101, 0)
SWEP.RunSightsPos = Vector (3.88, -2, 0.6)
SWEP.RunSightsAng = Vector (-10.2, 50, 0)
SWEP.InspectPos = Vector(6, -3, 1)
SWEP.InspectAng = Vector(15, 50, 5)
