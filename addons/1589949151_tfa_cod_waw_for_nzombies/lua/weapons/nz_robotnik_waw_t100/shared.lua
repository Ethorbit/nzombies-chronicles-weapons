...
SWEP.PrintName				= "Type-100"		-- Weapon name (Shown on HUD)	
...
function SWEP:OnPaP()
    ...
    self.Primary.MaxAmmo = 220
    self.Primary.RPM = 923
    self.Primary.DamageHeadshot = 5.5 -- Headshot damage per bullet
    self:ClearStatCache()
    return true
end

-- Enter iron sight info and bone mod info below
SWEP.SightsPos = Vector(-2.365, -2.56, 2.575)
SWEP.SightsAng = Vector(-1, 0.82, 5)
SWEP.RunSightsPos = Vector (1, 0, 1.5)
SWEP.RunSightsAng = Vector (-15, 25, -15)
SWEP.InspectPos = Vector(2, 2, -2)
SWEP.InspectAng = Vector(15, 12.199, -10.4)
SWEP.VMPos = Vector(-0.5, -1, 0)
