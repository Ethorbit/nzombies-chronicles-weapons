...
SWEP.SightsPos = Vector(-3.475, 0, 1.559)
SWEP.SightsAng = Vector(-0.101, -0.201, 0)
SWEP.RunSightsPos = Vector (5, -6, -3.5)
SWEP.RunSightsAng = Vector (10, 60, 0)
SWEP.InspectPos = Vector(5, -5, 3.5)
SWEP.InspectAng = Vector(10, 55, 10)
SWEP.VMPos = Vector(0.5, -0.4, 0)
