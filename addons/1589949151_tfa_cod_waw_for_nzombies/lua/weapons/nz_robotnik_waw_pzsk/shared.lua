...
SWEP.ProjectileRadius = NZCoDRadius(6.5024)
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = NZCoDDMG(1250) -- changement des dégats pour le pack a punch
	self.Primary.ClipSize = 3 -- changement du chargeur pour le pack a punch
	self.Primary.MaxAmmo = 42 -- changement des balles en réserve pour le pack a punch
	self:ClearStatCache()
	return true
end
