...
function SWEP:OnPaP()
    ...
    self.Primary.RPM = 1363
    self.Primary.DamageHeadshot = 3.5 -- Headshot damage per bullet
    self:ClearStatCache()
    return true
end
...
SWEP.SightsPos = Vector(-5.901, 0, 2.64)
SWEP.SightsAng = Vector(0, 0, 0)
SWEP.RunSightsPos = Vector (4.639, -4, -2)
SWEP.RunSightsAng = Vector (1, 55, 0)
SWEP.InspectPos = Vector(4, 0, 1)
SWEP.InspectAng = Vector(10, 40, 0)
