...
SWEP.ViewModel				= "models/weapons/c_mw2_deagle.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mw2_deag_new1.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("robotnik_mw2_deagle.Single")		-- Script that calls the primary fire sound
...
SWEP.VMPos = Vector(1, 1.5, -0.5)
SWEP.VMAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-2.721, -1.5, 1.379)
SWEP.SightsAng = Vector(0.17, 0.01, 0)
SWEP.RunSightsPos = Vector ()
SWEP.RunSightsAng = Vector ()
SWEP.InspectPos = Vector(7, -9, 3)
SWEP.InspectAng = Vector(5, 45, 10)
