...
SWEP.PrintName				= "Thumper"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_mw2_thumper_new2.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mw2_thumper_new.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mw2_thumper_new.Single")		-- Script that calls the primary fire sound
...
function SWEP:OnPaP()
    ...
    self.Primary.Damage = 1000 -- changement des dégats pour le pack a punch
    self.Primary.ClipSize = 3 -- changement du chargeur pour le pack a punch
    self.Primary.MaxAmmo = 25 -- changement des balles en réserve pour le pack a punch
    self:ClearStatCache()
    return true
end

-- Enter iron sight info and bone mod info below
SWEP.SightsPos = Vector(-3.171, -9.801, -2.961)
SWEP.SightsAng = Vector(17.7, 0, 0)
SWEP.RunSightsPos = Vector (1.639, 0, -2.681)
SWEP.RunSightsAng = Vector (-8.101, 42, -14.7)
SWEP.InspectPos = Vector(7.32, 0, 1.48)
SWEP.InspectAng = Vector(3.299, 36.4, 9.3)
