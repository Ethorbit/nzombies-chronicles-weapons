...
SWEP.BlowbackBoneMods = {
	["j_bolt"] = { scale = Vector(1, 1, 1), pos = Vector(-2.093, 0, 0), angle = Angle(0, 0, 0) },
	["tag_weapon"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-1.142, 0, 0) },
	["j_press_rear"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-47.96, 0, 0) }
}
...
SWEP.ViewModel				= "models/weapons/c_mw2_m9.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mw2_m9_new.mdl"	-- Weapon world model
...
SWEP.SightsPos = Vector(-2.136, -1.727, 1.679)
SWEP.SightsAng = Vector(-2.201, -0.101, 0)
SWEP.RunSightsPos = Vector ()
SWEP.RunSightsAng = Vector ()
SWEP.InspectPos = Vector(11.359, -5.321, 0.4)
SWEP.InspectAng = Vector(22.2, 35.7, 27.7)
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = 58
	self.Primary.ClipSize = 27
	self.Primary.MaxAmmo = 216
	self:ClearStatCache()
...
SWEP.VElements = {
	["mw2_sil"] = { type = "Model", model = "models/weapons/_mw2_attach/robotnik_mw2_silencer.mdl", bone = "tag_weapon", rel = "", pos = Vector(7.381, 0, 0.639), angle = Angle(0, 0, 0), size = Vector(0.321, 0.321, 0.321), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {},active = false }
}
SWEP.Offset = {
        Pos = {
        Up = 0.5,
