...
SWEP.NZPaPName = "Universal Slaying Pistol"
...
SWEP.ViewModel				= "models/weapons/c_mw2_usp.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mw2_usp_new.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("robotnik_mw2_usp.Single")		-- Script that calls the primary fire sound
...
SWEP.Primary.ClipSize_XM		= 32		-- Size of a clip
...
hook.Add( "PlayerCanPickupWeapon", "setammo_usp45", function( ply, wep )
	timer.Simple(0.1, function()
		if IsValid(wep) and wep:GetClass() == "nz_robotnik_mw2_usp" and ply:GetAmmoCount( "nz_weapon_ammo_1" ) > 36 and !wep:HasNZModifier("pap") then
			ply:RemoveAmmo( 30, "nz_weapon_ammo_1" )
		end
	end)
end)

-- Enter iron sight info and bone mod info below
SWEP.SightsPos = Vector(-1.981, -0.657, 1.399)
SWEP.SightsAng = Vector(-1.201, -0.101, 0)
SWEP.RunSightsPos = Vector ( )
SWEP.RunSightsAng = Vector ( )
SWEP.InspectPos = Vector(5.639, 0, 1.08)
SWEP.InspectAng = Vector(4.9, 19.6, 14.199)
SWEP.VElements = {
	["mw2_sil"] = { type = "Model", model = "models/weapons/_mw2_attach/robotnik_mw2_silencer.mdl", bone = "tag_weapon", rel = "", pos = Vector(6.735, 0.07, 0.398), angle = Angle(0, 0, 0), size = Vector(0.337, 0.337, 0.337), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {},active = false }
}
