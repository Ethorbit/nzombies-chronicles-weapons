...
SWEP.Primary.DamageRange = NZCoDRange(15)
...
SWEP.VMPos = Vector(0.7, 2, -0.7)
SWEP.VMAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-4.101, -2, 2.67)
SWEP.SightsAng = Vector(0.13, 0, 0)
SWEP.RunSightsPos = Vector()
SWEP.RunSightsAng = Vector()
SWEP.InspectPos = Vector(8, -6, 2)
