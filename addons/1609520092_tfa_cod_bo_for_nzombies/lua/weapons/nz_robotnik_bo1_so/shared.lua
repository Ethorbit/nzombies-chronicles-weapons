...
SWEP.Primary.DamageRange = NZCoDRange(8.62)
...
SWEP.Primary.DefaultClip		= 54	-- Default number of bullets in a clip
...
SWEP.VMPos = Vector(0.7, 1, -0.5)
SWEP.VMAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-2.901, 1, 1.879)
SWEP.SightsAng = Vector(0.2, 0, 0)
SWEP.InspectPos = Vector(6, -2.5, 0.5)
SWEP.InspectAng = Vector(15, 55, 5)
