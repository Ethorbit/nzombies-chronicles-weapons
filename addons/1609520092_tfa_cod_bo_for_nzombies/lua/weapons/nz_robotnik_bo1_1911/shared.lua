--SWEP.NZPaPReplacement = "tfa_mustangandsally" -- this shit is broken beyond repair
...
hook.Add( "PlayerCanPickupWeapon", "setammo_m1911", function( ply, wep )
	timer.Simple(0.2, function()
		if IsValid(wep) and wep:GetClass() == "nz_robotnik_bo1_1911" and ply:GetAmmoCount( "nz_weapon_ammo_1" ) > 32 and !wep:HasNZModifier("pap") then
...
SWEP.SightsPos = Vector(-2.198, 0, 1.3)
SWEP.SightsAng = Vector(0.2, 0, 0)
SWEP.RunSightsPos = Vector ()
SWEP.RunSightsAng = Vector ()
SWEP.InspectPos = Vector(3.819, -2.056, 0.509)
SWEP.InspectAng = Vector(13.199, 16.899, 27.236)
