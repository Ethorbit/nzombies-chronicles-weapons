...
SWEP.Type			= "Crossbow"
SWEP.ProjectileEntity = "bo1_crossbow_arrow" --Entity to shoot -- tfbow_arrow
...
SWEP.Primary.Damage		= NZCoDDMG(400)	-- Base damage per bullet
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = NZCoDDMG(2500)
end