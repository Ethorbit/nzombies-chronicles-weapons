...
sound.Add( {
	...
	level = 100,
	pitch = {100, 100},
	sound = "weapons/tesla_gun/proj_impact.wav"
} )
...
if SERVER then
	...
	function ENT:StartTouch(ent)
		if (ent:GetClass() == "wall_block" || ent:GetClass() == "invis_wall" || ent:GetClass() == "invis_wall_block" || ent:GetClass() == "prop_dynamic") or (ent:GetClass() == "nz_spawn_zombie_normal") or (ent:GetClass() == "nz_spawn_zombie_special") or (ent:GetClass() == "nz_spawn_player") then return end
