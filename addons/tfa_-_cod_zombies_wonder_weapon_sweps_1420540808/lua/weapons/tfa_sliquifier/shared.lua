...
SWEP.Contact				= ""
SWEP.Purpose				= "Made in China (literally), this post-apocalyptic handcrafted wonder weapon shoots ooze that can explode zombies while slip n' slidin on the ooze"
SWEP.Instructions				= ""
...
SWEP.ViewModel				= "models/weapons/sliquifier/nzc_c_slipgun.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/sliquifier/nzc_w_slipgun.mdl"	-- Weapon world model
...
SWEP.IronSightsPos = Vector(-3.07, 0.58, 0.75)
SWEP.IronSightsAng = Vector(-0.68, 0.0, 0)
...
if self.Ispackapunched == 1 then
		...
		self.Owner:GetViewModel():SetSubMaterial(1, "models/weapons/slipgun/zmb_slipgun_scroll_p")
else
