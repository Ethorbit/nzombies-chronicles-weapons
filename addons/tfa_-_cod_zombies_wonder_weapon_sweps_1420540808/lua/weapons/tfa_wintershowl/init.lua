...
local dmgtype = bit.bor(DMG_GENERIC)
...
local function unfreeze(ent,kill,inf,stack)
	...
	elseif ent.Type == "nextbot" then
		-- this code was added by a fucking retard twice
        -- let me comment it out a second time so it stops breaking the game
...
function SWEP:FreezeFunc(ent,kil,inf,type)
	...
	elseif type == 2 then
		-- this code was added by a fucking retard
        -- let me comment it out so it stops breaking the game
