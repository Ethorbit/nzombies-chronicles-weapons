...
SWEP.DrawCrosshairIS = false --D0aw the crosshair in ironsights?
...
--Firing related
SWEP.Primary.Sound 			= Sound("weapons/blundergat/acidgat_fire.mp3")				-- This is the sound of the weapon, when you shoot.
...
self.Primary.Sound 			= Sound("weapons/blundergat/fire.wav")
...
SWEP.ProjectileModel = "models/weapons/blundergat/nzc2_acidgat_projectile.mdl"

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/blundergat/nzc2_c_acidgat.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/blundergat/nzc2_w_acidgat.mdl" -- Weapon world model path
	...
	aimcone = 20
		...
		if SERVER then
			for _ = 1, num_bullets do
				...
				if self.Ispackapunched == 1 then
					ent.Upgraded = true
					ent:EmitSound("nz/effects/pap_laser_shot.wav")
				end
