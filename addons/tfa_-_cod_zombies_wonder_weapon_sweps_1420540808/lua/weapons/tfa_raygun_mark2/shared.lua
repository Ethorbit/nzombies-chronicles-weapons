...
SWEP.Purpose				= "Kill zombies with this classic Jimmy Zielenski Wonder Weapon" --Purpose Tooltip
...
SWEP.Primary.Damage	= NZCoDDMG(2300)					-- Damage, in standard damage points.
SWEP.Primary.DamageHeadshot = 23
...
SWEP.ViewModel			= "models/weapons/raygun2/nzc2_v_raygun2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/raygun2/nzc2_w_raygun2.mdl" -- Weapon world model path
...
function SWEP:PreDrawViewModel( vm )
	if self.Ispackapunched == 1 then
		self.Owner:GetViewModel():SetSubMaterial(0, "models/weapons/common/ritual_camo_pap.vmt")
