...
SWEP.SightsPos = Vector(-2.225, -3.245, 0.219)
SWEP.SightsAng = Vector(0.1, 0, 0)
SWEP.RunSightsPos = Vector ()
SWEP.RunSightsAng = Vector ()
SWEP.InspectPos = Vector(9.159, 0, -4.678)
SWEP.InspectAng = Vector(25.399, 41, 10.899)
SWEP.IronSightsPos_G11 = Vector(-2.241, 0, -0.08)
