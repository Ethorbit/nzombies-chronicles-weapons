...
SWEP.Primary.RPM				= 341		-- This is in Rounds Per Minute
...
SWEP.SightsPos = Vector(-2.26, 0, 0.36)
SWEP.SightsAng = Vector(-0.101, 0.059, 0)
SWEP.RunSightsPos = Vector()
SWEP.RunSightsAng = Vector()
SWEP.InspectPos = Vector(5.119, 0, 0.519)
SWEP.InspectAng = Vector(6.099, 34.7, 6.4)
