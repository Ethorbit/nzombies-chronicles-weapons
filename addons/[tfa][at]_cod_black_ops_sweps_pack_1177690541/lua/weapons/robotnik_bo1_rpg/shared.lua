...
SWEP.NZPaPName = "Rocket Propelled Gore"
...
SWEP.ViewModel				= "models/weapons/c_bo1_rpg.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_bo1_rpg.mdl"	-- Weapon world model
...
SWEP.ViewModelBoneMods = {
	["tag_view"] = { scale = Vector(1, 1, 1), pos = Vector(1.302, -4.143, 2.484), angle = Angle(4.446, 0, 0) }
}
