...
ATTACHMENT.Name = "AUG SCOPE"
ATTACHMENT.Description = {TFA.AttachmentColors["="], "4x zoom", TFA.AttachmentColors["-"], "15% higher zoom time"}
ATTACHMENT.Icon = "entities/blops_acog.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "AUGSCOPE"

ATTACHMENT.WeaponTable = {
	["VElements"] = {
		["blops_augscope_rtcircle"] = {
			["active"] = true
		},
			["blops_augscope"] = {
			["active"] = true
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_AUG or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_AUG or val, true end,
		["Primary"] = {
...
local myret = Material("scope/augsight")
