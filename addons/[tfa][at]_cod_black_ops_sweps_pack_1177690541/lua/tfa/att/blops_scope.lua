...
ATTACHMENT.Name = "Rifle Scope"
ATTACHMENT.Description = {TFA.AttachmentColors["="], "8x zoom", TFA.AttachmentColors["-"], "25% higher zoom time"}
...
ATTACHMENT.ShortName = "8x Scope"

ATTACHMENT.WeaponTable = {
	["VElements"] = {
		["blops_scope_rtcircle"] = {
			["active"] = true
		},
		["siderail"] = {
			["active"] = true
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_8X or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_8X or val, true end,
		["Primary"] = {
