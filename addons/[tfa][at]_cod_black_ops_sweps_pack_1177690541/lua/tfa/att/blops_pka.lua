...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_BO1_ACOG or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_BO1_ACOG or val, true end,
		["Primary"] = {
...
local myret = Material("custom/pka")
