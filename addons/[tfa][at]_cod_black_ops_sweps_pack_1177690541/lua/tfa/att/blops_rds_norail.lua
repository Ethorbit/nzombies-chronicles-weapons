...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function(wep, val) return wep.IronSightsPos_RDS_N or val, true end,
	["IronSightsAng"] = function(wep, val) return wep.IronSightsAng_RDS_N or val, true end,
