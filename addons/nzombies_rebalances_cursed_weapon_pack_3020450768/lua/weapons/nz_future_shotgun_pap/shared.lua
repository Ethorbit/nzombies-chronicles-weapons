...
SWEP.PrintName				= "Synth Suppressor"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Synth Suppressor"
...
SWEP.Primary.RPM			= 420			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 16		-- Size of a clip
SWEP.Primary.DefaultClip		= 128		-- Bullets you start with
SWEP.Primary.KickUp				= 0.075		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.075		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.075		-- Maximum up recoil (stock)
...
SWEP.Primary.Damage		= 112	-- Base damage per bullet
SWEP.Primary.DamageHeadshot 	= 2.25
...
SWEP.VElements = {
	...
	["handle"] = { type = "Model", model = "models/Items/combine_rifle_cartridge01.mdl", bone = "ValveBiped.base", rel = "", pos = Vector(0, 4.454, -0.797), angle = Angle(0, -90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(102, 102, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["stock"] = { type = "Model", model = "models/Items/combine_rifle_cartridge01.mdl", bone = "ValveBiped.base", rel = "", pos = Vector(0.093, 1.021, -9.705), angle = Angle(-90, 90, 180), size = Vector(0.5, 0.5, 0.5), color = Color(102, 102, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["scope"] = { type = "Model", model = "models/props_combine/breenlight.mdl", bone = "ValveBiped.base", rel = "", pos = Vector(0.079, -3.32, 0), angle = Angle(-1.806, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(102, 102, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["body"] = { type = "Model", model = "models/props_combine/suit_charger001.mdl", bone = "ValveBiped.base", rel = "", pos = Vector(0, -0.304, -3.047), angle = Angle(0, 0, 0), size = Vector(0.196, 0.196, 0.519), color = Color(102, 102, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["muzzle"] = { type = "Model", model = "models/dav0r/thruster.mdl", bone = "ValveBiped.base", rel = "", pos = Vector(0, -0.278, 9.005), angle = Angle(0, 180, 0), size = Vector(0.5, 0.5, 1.684), color = Color(102, 102, 255, 255), surpresslightning = false, material = "models/dav0r/hoverball", skin = 0, bodygroup = {} }
}
