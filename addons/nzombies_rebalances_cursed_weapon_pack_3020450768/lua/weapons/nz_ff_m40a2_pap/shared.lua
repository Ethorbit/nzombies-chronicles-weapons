...
SWEP.PrintName				= "Extender Bender"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Extender Bender"
...
SWEP.Primary.Damage		= 126	-- Base damage per bullet
SWEP.Primary.DamageHeadshot 	= 4
SWEP.Primary.Spread		= .00955	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
...
SWEP.ViewModelBoneMods = {
	["v_weapon.m4_Clip"] = { scale = Vector(1, 3, 1), pos = Vector(0, -1.032, 0), angle = Angle(0, 0, 0) }
}
