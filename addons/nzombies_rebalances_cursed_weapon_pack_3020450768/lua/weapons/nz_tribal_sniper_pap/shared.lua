...
SWEP.PrintName				= "Bigwigian Dart"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Bigwigian Dart"
...
SWEP.Primary.KickUp			= .07				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= .07			-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal			= .07		-- Maximum up recoil (stock)
...
SWEP.VElements = {
	...
	["scopeback+"] = { type = "Model", model = "models/hunter/tubes/tube4x4x1to2x2.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(-0.245, -2.291, -0.853), angle = Angle(0, 0, 180), size = Vector(0.019, 0.014, 0.064), color = Color(32, 24, 11, 255), surpresslightning = false, material = "phoenix_storms/dome", skin = 0, bodygroup = {} },
	["scopebar"] = { type = "Model", model = "models/mechanics/solid_steel/i_beam_4.mdl", bone = "ValveBiped.Pump", rel = "", pos = Vector(0.079, -0.732, -4.689), angle = Angle(0, -90, 0), size = Vector(0.065, 0.065, 0.065), color = Color(32, 24, 11, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["scopelook++"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0.469, -2.306, -19.025), angle = Angle(0, 0, 0), size = Vector(0.128, 0.128, 0.009), color = Color(32, 24, 11, 255), surpresslightning = false, material = "debug/env_cubemap_model", skin = 0, bodygroup = {} },
	["scopeback"] = { type = "Model", model = "models/hunter/tubes/tube4x4x1to2x2.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0.488, -2.293, -15), angle = Angle(0, 0, 0), size = Vector(0.019, 0.019, 0.064), color = Color(32, 24, 11, 255), surpresslightning = false, material = "phoenix_storms/dome", skin = 0, bodygroup = {} },
	["rail"] = { type = "Model", model = "models/props_phx/gears/rack9.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0.162, 0, -9.546), angle = Angle(1.389, 0, -90.858), size = Vector(0.174, 0.174, 0.174), color = Color(32, 24, 11, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["scopelook+"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(-0.183, -2.392, 1.623), angle = Angle(0, 0, 0), size = Vector(0.135, 0.09, 0.023), color = Color(32, 24, 11, 255), surpresslightning = false, material = "phoenix_storms/dome", skin = 0, bodygroup = {} },
	["scopebar+"] = { type = "Model", model = "models/mechanics/solid_steel/i_beam_4.mdl", bone = "ValveBiped.Pump", rel = "", pos = Vector(0.238, -0.653, -10), angle = Angle(0, -90, 0), size = Vector(0.065, 0.065, 0.065), color = Color(32, 24, 11, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["gun"] = { type = "Model", model = "models/weapons/w_annabelle.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(-1.017, 3.006, 0.153), angle = Angle(-97.455, 90, -8.336), size = Vector(1.297, 1.297, 1.297), color = Color(85, 232, 95, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scopelook"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0.469, -2.306, -19), angle = Angle(0, 0, 0), size = Vector(0.135, 0.135, 0.023), color = Color(32, 24, 11, 255), surpresslightning = false, material = "phoenix_storms/dome", skin = 0, bodygroup = {} }
}
