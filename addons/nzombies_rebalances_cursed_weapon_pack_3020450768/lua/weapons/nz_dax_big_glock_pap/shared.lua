...
SWEP.PrintName				= "Torso Breaker"
SWEP.NZPaPName				= "Torso Breaker"
SWEP.Slot					= 1
SWEP.Type 					= "Anti-material Pistol"
...
SWEP.Primary.DefaultClip 		= 133
SWEP.Primary.Ammo 			= "pistol"
SWEP.DisableChambering 			= true
SWEP.Primary.MaxAmmo 			= 133
...
SWEP.Primary.SpreadRecovery 		= 1.5
