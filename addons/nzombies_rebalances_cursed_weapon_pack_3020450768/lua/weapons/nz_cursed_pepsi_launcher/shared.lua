...
SWEP.Gun = ("nz_cursed_pepsi_launcher") -- must be the name of your swep but NO CAPITALS!
SWEP.Category				= "[TFA] [NZ] Cursed Weapons" --Category where you will find your weapons
...
SWEP.NZPaPReplacement			= "nz_cursed_pepsi_launcher_pap"
