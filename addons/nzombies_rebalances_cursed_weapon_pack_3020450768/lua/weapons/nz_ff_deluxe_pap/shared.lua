...
SWEP.Author				= ""
SWEP.Contact				= ""
SWEP.Purpose				= "A famas that can switch between automatic and shotgun modes?!"
SWEP.Instructions				= ""
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.MuzzleFlashEffect = "pap_muzzleflash"
SWEP.ShellEjectAttachment			= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Luxurious Le Clairon"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Luxurious Le Clairon"
...
SWEP.Primary.RPM			= 960			-- This is in Rounds Per Minute
...
function SWEP:SecondaryAttack()
    ...
    self.Primary_TFA.AmmoConsumption = 4
	self.Primary_TFA.NumShots = 12
	self.Primary_TFA.Damage = 126
	self.Primary.DamageHeadshot 	= 3.5
	self.Primary_TFA.KickUp				= 0.75
	self.Primary_TFA.KickDown			= 0.75
	self.Primary_TFA.KickHorizontal		= 0.75
