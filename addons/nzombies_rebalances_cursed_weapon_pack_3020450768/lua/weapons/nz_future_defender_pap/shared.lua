...
SWEP.PrintName				= "Selfish Control"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Selfish Control"
...
SWEP.Primary.DamageHeadshot 	= 4.5
SWEP.Primary.Spread		= .0095	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
