...
SWEP.PrintName				= "Victorian Hammer"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Victorian Hammer"
...
SWEP.Primary.Damage		= 210	--base damage per bullet
SWEP.Primary.DamageHeadshot 	= 4.2
...
SWEP.VElements = {
	...
	["top"] = { type = "Model", model = "models/props_combine/headcrabcannister01a.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0, -6.815, -7.206), angle = Angle(-90, 0, 0), size = Vector(0.196, 0.097, 0.063), color = Color(228, 102, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["stock"] = { type = "Model", model = "models/Gibs/helicopter_brokenpiece_05_tailfan.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(-1.14, -5.032, 14.317), angle = Angle(-90, 90, 0), size = Vector(0.068, 0.068, 0.098), color = Color(28, 102, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["handle"] = { type = "Model", model = "models/props_combine/breenlight.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0, -0.649, 0.804), angle = Angle(121.417, -90, -0.449), size = Vector(0.323, 0.323, 0.323), color = Color(228, 102, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rail"] = { type = "Model", model = "models/props_combine/combinethumper002.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.079, -2.418, 8.361), angle = Angle(0, 90, -180), size = Vector(0.151, 0.034, 0.145), color = Color(228, 102, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["bolt"] = { type = "Model", model = "models/props_c17/TrapPropeller_Lever.mdl", bone = "v_weapon.awm_bolt_action", rel = "", pos = Vector(0, 0.483, 0), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(28, 102, 255, 255), surpresslightning = false, material = "models/dav0r/hoverball", skin = 0, bodygroup = {} },
