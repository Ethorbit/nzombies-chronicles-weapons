...
SWEP.Author				= ""
SWEP.Contact				= ""
SWEP.Purpose				= "banana bunch mag"
SWEP.Instructions				= ""
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.MuzzleFlashEffect = "pap_muzzleflash"
SWEP.ShellEjectAttachment			= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Viktor's Bunch Mag"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Viktor's Bunch Mag"
...
SWEP.Primary.RPM			= 990			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 76		-- Size of a clip
SWEP.Primary.DefaultClip		= 760		-- Bullets you start with
SWEP.Primary.KickUp				= 0.095		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.095		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.095		-- Maximum up recoil (stock)
SWEP.Primary.Knockback = 0
SWEP.Primary.Automatic			= true		-- Automatic = true; Semi Auto = false
SWEP.Primary.Ammo			= "ar2"
SWEP.Secondary.IronFOV			= 55		-- How much you 'zoom' in. Less is more! 	
SWEP.Primary.MaxAmmo 			= 760
...
SWEP.Primary.DamageHeadshot 	= 3.2
...
SWEP.VElements = {
	["banana"] = { type = "Model", model = "models/props/cs_italy/bananna_bunch.mdl", bone = "v_weapon.AK47_Clip", rel = "", pos = Vector(-0.85, 6.918, -3.125), angle = Angle(0, 0, -121.597), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
