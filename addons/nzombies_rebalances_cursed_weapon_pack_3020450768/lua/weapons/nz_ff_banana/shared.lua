...
SWEP.PrintName				= "Unripe Banana Pistol"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPReplacement			= "nz_ff_banana_pap"
...
SWEP.Primary.DefaultClip		= 152		-- Bullets you start with
...
SWEP.VElements = {
	["bananamag"] = { type = "Model", model = "models/props/cs_italy/banannagib1.mdl", bone = "v_weapon.p228_Clip", rel = "", pos = Vector(0.796, -0.995, -2.421), angle = Angle(180, 0, 90), size = Vector(0.726, 0.726, 0.726), color = Color(150, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["banana"] = { type = "Model", model = "models/props/cs_italy/bananna.mdl", bone = "v_weapon.p228_Parent", rel = "", pos = Vector(0.801, -3.586, -1.537), angle = Angle(180, 0, 90), size = Vector(0.727, 0.727, 0.727), color = Color(150, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
