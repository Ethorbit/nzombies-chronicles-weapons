...
SWEP.PrintName				= "Sheckley's Coil"		-- Weapon name (Shown on HUD)
SWEP.NZPaPName				= "Sheckley's Coil"	
...
SWEP.Primary.DamageHeadshot 	= 2.2
SWEP.Primary.Spread		= .00030	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .00030 -- Ironsight accuracy, should be the same for shotguns
