...
SWEP.PrintName				= "God's Sidearm"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "God's Sidearm"
...
SWEP.Primary.DefaultClip			= 125	-- Bullets you start with
...
SWEP.Primary.DamageHeadshot 	= 5.2
...
SWEP.VElements = {
	...
	["skull"] = { type = "Model", model = "models/Gibs/HGIBS.mdl", bone = "Python", rel = "", pos = Vector(-0.322, 0.272, -1.999), angle = Angle(-96.504, 90.725, 1.478), size = Vector(0.246, 0.246, 0.246), color = Color(192, 102, 78, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["gun"] = { type = "Model", model = "models/weapons/w_annabelle.mdl", bone = "Python", rel = "", pos = Vector(-1.211, 1.57, 1.491), angle = Angle(-108.95, 84.06, -5.843), size = Vector(0.3, 0.742, 0.963), color = Color(192, 102, 78, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
