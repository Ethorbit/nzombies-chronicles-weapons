...
SWEP.PrintName				= "Biblical Musket"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Biblical Musket"
...
SWEP.Primary.KickUp			= .035				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= .035			-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal			= .035		-- Maximum up recoil (stock)
...
SWEP.IronSightsPos = Vector(-8.45, -4.278, 5.559)
SWEP.IronSightsAng = Vector(-1.501, 1.5, 0)
SWEP.SightsPos = Vector(-8.45, -4.278, 5.559)
SWEP.SightsAng = Vector(-1.501, 1.5, 0)
...
SWEP.VElements = {
	...
	["rail"] = { type = "Model", model = "models/props_phx/gears/rack9.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0.162, 0, -9.546), angle = Angle(1.389, 0, -90.858), size = Vector(0.174, 0.174, 0.174), color = Color(12, 32, 50, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["gun"] = { type = "Model", model = "models/weapons/w_annabelle.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(-1.017, 3.006, 0.153), angle = Angle(-97.455, 90, -8.336), size = Vector(1.297, 1.297, 1.297), color = Color(95, 106, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
