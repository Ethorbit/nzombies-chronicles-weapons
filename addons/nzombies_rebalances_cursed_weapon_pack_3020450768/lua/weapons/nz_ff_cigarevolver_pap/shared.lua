...
SWEP.Author				= ""
SWEP.Contact				= ""
SWEP.Purpose				= "Supplied by your local 7/11"
SWEP.Instructions				= ""
...
SWEP.PrintName				= "Stone Newports"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Stone Newports"
...
SWEP.Primary.Damage		= 196	-- Base damage per bullet
