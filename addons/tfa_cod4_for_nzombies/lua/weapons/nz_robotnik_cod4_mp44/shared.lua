...
SWEP.BlowbackBoneMods = {
	["j_bolt"] = { scale = Vector(1, 1, 1), pos = Vector(-5.071, 0, 0), angle = Angle(0, 0, 0) },
	["tag_weapon"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-1, 0, 0) }
}
...
SWEP.PrintName				= "MP44"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/c_cod4_mp44.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_cod4_mp44_c.mdl"	-- Weapon world model
...
SWEP.SightsPos = Vector(-2.576, -1.361, 0.56)
SWEP.SightsAng = Vector(0.3, 0.029, 0)
SWEP.RunSightsPos = Vector ( )
SWEP.RunSightsAng = Vector ( )
SWEP.InspectPos = Vector(5.959, 0, 1.513)
SWEP.InspectAng = Vector(10.6, 39.5, 18.5)
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = NZCoDDMG(146)
