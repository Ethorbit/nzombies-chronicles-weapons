...
ATTACHMENT.Icon = "entities/cod4_holo.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
ATTACHMENT.WeaponTable = {
	...
	["BlowbackVector"] = Vector(0.00,-0.25,0.00)
}
