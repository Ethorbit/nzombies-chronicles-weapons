...
local zoom = 4 --Your desired scope zoom
...
ATTACHMENT.Icon = "entities/cod4_acog.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
local myret = Material("models/weapons/v_models/CoD4/_attach/weapon_acog_reticle_col")
