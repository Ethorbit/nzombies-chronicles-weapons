...
SWEP.PrintName				= "Super Shotgun"		-- Weapon name (Shown on HUD)	
...
sound.Add({
	name = 			"SWeapon_Super.1",
	channel = 		CHAN_WEAPON,
	volume = 		1.0,
	sound = 			"weapons/m3/m3-1.wav"
})

SWEP.Primary.Sound			= Sound("SWeapon_Super.1")		-- script that calls the primary fire sound
...
SWEP.Primary.KickUp			= 6.4				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 5.2		-- Maximum down recoil (skeet)
