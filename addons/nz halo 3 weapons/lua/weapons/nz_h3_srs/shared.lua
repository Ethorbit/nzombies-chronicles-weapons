...
SWEP.Gun = ("nz_h3_srs") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "SRS99D-S2 AM"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPReplacement		= "nz_h3_srs_pap"
