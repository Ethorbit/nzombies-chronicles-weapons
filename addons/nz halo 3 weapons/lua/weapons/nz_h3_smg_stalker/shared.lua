...
SWEP.NZPaPReplacement		= "nz_h3_smg_stalker_pap"
...
SWEP.WorldModel					= "models/halo_3/smg_sil_w.mdl"	-- Weapon world model
...
SWEP.Primary.KickDown			= 0.077			-- Maximum down recoil (skeet)
