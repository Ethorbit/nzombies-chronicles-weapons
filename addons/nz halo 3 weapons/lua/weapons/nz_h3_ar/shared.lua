...
SWEP.NZPaPReplacement			= "nz_h3_ar_pap"
...
SWEP.Primary.DefaultClip		= 352		-- Bullets you start with
SWEP.Primary.KickUp				= 0.097		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.07		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.03		-- Maximum up recoil (stock)
...
SWEP.Primary.DamageHeadshot		= 1.70
