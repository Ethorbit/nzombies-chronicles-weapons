...
SWEP.Gun 						= ("nz_h3_ar") -- must be the name of your swep but NO CAPITALS!
SWEP.Category					= "[TFA] [NZ PAP] Halo 3"
SWEP.Author						= "Stan"
SWEP.Contact					= "Don't"
SWEP.Purpose					= "An otherworldly rifle fit for warrior."
SWEP.Instructions				= "Point and shoot at any alien son of a bitch"
SWEP.MuzzleAttachment			= "1" 		-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment		= "2" 		-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName					= "Hal's Rifle"	-- Weapon name (Shown on HUD)	
SWEP.NZPaPName					= "Hal's Rifle"
...
SWEP.WorldModel				= "models/ar.mdl"	-- Weapon world model
...
SWEP.Primary.DefaultClip		= 660		-- Bullets you start with
SWEP.Primary.KickUp				= 0.053		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.037		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.065		-- Maximum up recoil (stock)
SWEP.Primary.Automatic			= true		-- Automatic/Semi Auto
SWEP.Primary.Ammo			= "ar2"			-- pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, AirboatGun
SWEP.Primary.MaxAmmo 			= 660
...
SWEP.Primary.IronAccuracy 	= 0.0083 -- ironsight accuracy, should be the same for shotguns
