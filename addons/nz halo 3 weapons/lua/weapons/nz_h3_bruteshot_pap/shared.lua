...
SWEP.Gun 						= ("nz_h3_bruteshot_pap") -- must be the name of your swep but NO CAPITALS!
SWEP.Category					= "[TFA] [NZ PAP] Halo 3"
SWEP.Author						= "Stan"
SWEP.Contact					= "Don't"
SWEP.Purpose					= "They must love the smell of badass."
SWEP.Instructions				= ""
SWEP.MuzzleAttachment			= "1" 		-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment		= "2" 		-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName					= "Chieftain's Roar"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName					= "Chieftain's Roar"
...
SWEP.WorldModel					= "models/brute_shot.mdl"	-- Weapon world model
...
SWEP.Primary.KickHorizontal		= 0.0043	-- Maximum up recoil (stock)
...
SWEP.Primary.Spread				= 0.030		--define from-the-hip accuracy 1 is terrible, .0001 is exact)
