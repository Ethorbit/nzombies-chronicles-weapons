...
SWEP.NZPaPReplacement		= "nz_h3_smg_pap"
SWEP.Author					= "Stan"
SWEP.Contact				= "Don't"
SWEP.Purpose				= "Finish the fight..."
SWEP.Instructions			= "Point and shoot at any alien son of a bitch"
SWEP.PrintName				= "M7/Caseless Submachine Gun"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel					= "models/smg.mdl"	-- Weapon world model
...
SWEP.Primary.KickUp				= 0.20				-- Maximum up recoil (rise)
