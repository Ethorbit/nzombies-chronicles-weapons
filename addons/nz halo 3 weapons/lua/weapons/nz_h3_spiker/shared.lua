...
SWEP.Gun 					= ("nz_h3_spiker") -- must be the name of your swep but NO CAPITALS!
...
SWEP.NZPaPReplacement		= "nz_h3_spiker_pap"
...
SWEP.Primary.KickUp				= 0.201				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.084			-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.091	-- Maximum up recoil (stock)
...
SWEP.Primary.DamageHeadshot			= 2.15
