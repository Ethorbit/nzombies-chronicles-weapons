...
SWEP.PrintName 						= "BR55"
SWEP.NZPaPReplacement				= "nz_h3_br_pap"
...
SWEP.Primary.DefaultClip 			= 324
SWEP.Primary.MaxAmmo 				= 324
...
SWEP.Primary.StaticRecoilFactor 	= 0.016 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
