...
SWEP.Gun 						= ("tfa_h3_magnum_swep") -- must be the name of your swep but NO CAPITALS!
SWEP.Category					= "[TFA] [NZ PAP] Halo 3"
SWEP.Author						= "Stan"
SWEP.Contact					= "Don't"
SWEP.Purpose					= "Misriah's Massacre."
SWEP.Instructions				= "Point and shoot at any alien son of a bitch"
SWEP.MuzzleAttachment			= "1" 			-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment		= "2" 			-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName					= "Marathon Runner"			-- Weapon name (Shown on HUD)	
SWEP.NZPaPName					= "Marathon Runner"
...
SWEP.Primary.KickUp				= 0.098		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.054		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.041		-- Maximum up recoil (stock)
...
SWEP.Primary.DamageHeadshot			= 2.70
