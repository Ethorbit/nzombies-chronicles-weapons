...
SWEP.Author					= "Stan"
SWEP.Contact				= "Don't"
SWEP.Purpose				= "Cognitive Pimponance!"
SWEP.Instructions			= "Cognitive Pimponance!"
SWEP.MuzzleAttachment		= "1" 		-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment	= "2" 		-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Pumps at Sea"	-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Pumps at Sea"		
...
SWEP.WorldModel				= "models/shotty.mdl"	-- Weapon world model
SWEP.UseHands				= true
...
SWEP.Primary.KickDown			= 0.060		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.060		-- Maximum up recoil (stock)
...
SWEP.Shotgun 						= true
SWEP.LoopedReloadInsertAmount 		= 3
...
SWEP.Primary.Damage				= 117		-- base damage per bullet
SWEP.Primary.DamageHeadshot		= 2.50
...
SWEP.SequenceRateOverride = {
	[ACT_SHOTGUN_RELOAD_START] = 45 / 30,
	[ACT_VM_RELOAD] = 50 / 30,
