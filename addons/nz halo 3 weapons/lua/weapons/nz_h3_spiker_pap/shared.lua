...
SWEP.Gun 					= ("nz_h3_spiker_pap") -- must be the name of your swep but NO CAPITALS!
SWEP.Category				= "[TFA] [NZ PAP] Halo 3"
SWEP.Author					= "Stan"
SWEP.Contact				= "Don't"
SWEP.Purpose				= "Molten Spikes of love!"
SWEP.Instructions			= "Point and shoot at any alien son of a bitch"
SWEP.MuzzleAttachment		= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment	= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Jiralhanae Shafter"		-- Weapon name (Shown on HUD)	
SWEP.NZPaPName				= "Jiralhanae Shafter"
...
SWEP.WorldModel				= "models/spiker.mdl"	-- Weapon world model
SWEP.UseHands				= true
...
SWEP.Primary.RPM				= 777		-- This is in Rounds Per Minute
SWEP.Primary.Knockback          = 0
SWEP.Primary.ClipSize			= 77		-- Size of a clip
SWEP.Primary.DefaultClip		= 539		-- Bullets you start with
SWEP.Primary.KickUp				= 0.041				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.009			-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.012	-- Maximum up recoil (stock)
SWEP.Primary.Automatic			= true	-- Automatic/Semi Auto
SWEP.Primary.Ammo				= "357"	-- pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, AirboatGun
SWEP.Primary.MaxAmmo 			= 539
...
SWEP.Primary.IronAccuracy = 0.0117 -- ironsight accuracy, should be the same for shotguns
