...
SWEP.Gun 						= ("nz_h3_odst_socom_pap") -- must be the name of your swep but NO CAPITALS!
SWEP.Category					= "[TFA] [NZ PAP] Halo 3"
SWEP.Author						= "Stan"
SWEP.Contact					= "Don't"
SWEP.Purpose					= "BLAM! Said the lady!"
SWEP.Instructions				= "Point and shoot at any alien son of a bitch"
SWEP.MuzzleAttachment			= "1" 			-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment		= "2" 			-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName					= "Slam Blam"			-- Weapon name (Shown on HUD)
SWEP.NZPaPName					= "Slam Blam"	
...
SWEP.WorldModel					= "models/automag.mdl"	-- Weapon world model
SWEP.UseHands					= true
...
SWEP.Primary.DefaultClip		= 168		-- Bullets you start with
SWEP.Primary.KickUp				= 0.083		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.022		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.061		-- Maximum up recoil (stock)
SWEP.Primary.Automatic			= false		-- Automatic/Semi Auto
SWEP.Primary.Ammo				= "pistol"		-- pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, AirboatGun
SWEP.Primary.MaxAmmo 			= 168
...
SWEP.Primary.DamageHeadshot		= 4.00
SWEP.Primary.Spread		= 0.0065	--define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = 0.001170 -- ironsight accuracy, should be the same for shotguns
