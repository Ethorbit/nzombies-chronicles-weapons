...
SWEP.Gun = ("nz_h3_beam_rifle") -- must be the name of your swep but NO CAPITALS!
SWEP.Category					= "[TFA] [NZ PAP] Halo 3"
SWEP.Author						= "Stan"
SWEP.Contact					= "Don't"
SWEP.Purpose					= "Greetings!"
SWEP.Instructions				= "Point and shoot at any alien son of a bitch"
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment		= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName					= "Wort Keeoh-eesay"		-- Weapon name (Shown on HUD)
SWEP.NZPaPName					= "Wort Keeoh-eesay"
...
SWEP.UseHands					= true
SWEP.WorldModel					= "models/h3beamrifle.mdl"	-- Weapon world model
...
SWEP.Primary.KickUp				= 0.050				-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.031			-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.017	-- Maximum up recoil (stock)
...
SWEP.Primary.Damage		= 450	--base damage per bullet
SWEP.Primary.DamageHeadshot		= 6.00
