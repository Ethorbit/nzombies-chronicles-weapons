...
SWEP.Gun 						= ("nz_h3_odst_socom") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName					= "M6C/SOCOM"			-- Weapon name (Shown on HUD)	
SWEP.NZPaPReplacement			= "nz_h3_odst_socom_pap"
...
SWEP.Primary.KickUp				= 0.323		-- Maximum up recoil (rise)
SWEP.Primary.KickDown			= 0.092		-- Maximum down recoil (skeet)
SWEP.Primary.KickHorizontal		= 0.141		-- Maximum up recoil (stock)
