...
SWEP.Gun 						= ("nz_h3_rocket_launcher") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName					= "M41 SSR MAV/AW"	-- Weapon name (Shown on HUD)
SWEP.NZPaPReplacement			= "nz_h3_rocket_launcher_pap"
