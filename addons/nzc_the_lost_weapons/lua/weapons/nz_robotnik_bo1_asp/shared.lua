...
SWEP.BlowbackBoneMods = {
	["j_bolt"] = { scale = Vector(1, 1, 1), pos = Vector(-1.778, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.NZPaPName				= "AlwaysSuicidingPurposely"

SWEP.Category				= "[TFA][nZ] Call of Duty Black Ops: The Lost Weapons"
SWEP.Author				= "blunto"
SWEP.Contact				= ""
SWEP.Purpose				= "As genric as a pistol can get"
SWEP.Instructions				= ""
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment			= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "ASP"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/c_bo1_asp.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_bo1_asp.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = true

SWEP.Primary.Sound			= Sound("robotnik_bo1_asp.Single")		-- Script that calls the primary fire sound
SWEP.Primary.RPM			= 937			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 7		-- Size of a clip
SWEP.Primary.DefaultClip		= 35		-- Bullets you start with
...
SWEP.Primary.DamageHeadshot = 3.0
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = NZCoDDMG(2000)
	self.Primary.DamageHeadshot = 0
	self.Primary.RPM = 500
	self.Primary.DefaultClip = 80
	self.FireModes = {
	"Auto"
}
	self.Purpose				= "watch your jet bro WATCH YOUR JET"
	self.Primary.Automatic	= true
	self.ProjectileRadius = 315
...
SWEP.SightsPos = Vector(-3.237, -2.52, 1.6)
SWEP.SightsAng = Vector(2.099, 0.1, 0)
SWEP.RunSightsPos = Vector ()
SWEP.RunSightsAng = Vector ()
SWEP.InspectPos = Vector(6.25, 0, 0)
SWEP.InspectAng = Vector(11.5, 17.899, 21.231)
SWEP.Attachments = {
	[2] = {
		header = "ammo",
		offset = {0, 0},
