...
SWEP.RTOpaque = true
SWEP.NZPaPName = "Virtuosic Zombulator 6100"
SWEP.UseHands	= true
...
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions				= "machine pistol go brrr"
...
SWEP.ViewModel				= "models/weapons/c_bo1_skorpion.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_bo1_skorpion.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = true

SWEP.Primary.Sound			= Sound("robotnik_bo1_skorpion.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-3.044, -2.52, 0.66)
SWEP.SightsAng = Vector(0.899, 0.1, 0)
SWEP.RunSightsPos = Vector ()
SWEP.RunSightsAng = Vector ()
SWEP.InspectPos = Vector(8.92, 0, 0.159)
SWEP.InspectAng = Vector(8.899, 24.2, 16.799)


SWEP.VElements = {
	["blops_sil"] = { type = "Model", model = "models/weapons/_bo1_attach/robotnik_bo1_aksil.mdl", bone = "tag_weapon", rel = "", pos = Vector(11.545, 0.763, 0.462), angle = Angle(0, 0, -36.813), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {},active = false }
}
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = NZCoDDMG(138)
	self.Ispackapunched = 1
	self.Primary.ClipSize = 40
	timer.Simple(0.1, function()
		self:SetClip1(40)
	end)
	self.Primary.MaxAmmo = 480
