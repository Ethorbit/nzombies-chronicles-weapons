...
SWEP.Primary.Sound = Sound("Weapon_BO2_Rifles.fire_3") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickUp = 0.38 -- This is the maximum upwards recoil (rise)
...
SWEP.Primary.Damage = NZCoDDMG(145) -- Damage, in standard damage points.
...
function SWEP:OnPaP()
	...
	self.DamageHeadshot = 5
	self.FireModes = {"3Burst"}
