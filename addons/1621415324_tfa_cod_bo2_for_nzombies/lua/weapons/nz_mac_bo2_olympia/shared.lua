...
SWEP.Primary.Sound = Sound("Weapon_BO2_Shotguns.fire_1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SoundEchoTable = {
	[0] = Sound("Weapon_BO2_Shotguns.TailInside"), -- This is the sound of the weapon, when you shoot.
	[256] = Sound("Weapon_BO2_Shotguns.TailOutside") -- This is the sound of the weapon, when you shoot.
}
...
SWEP.Primary.Damage = NZCoDDMG(89.5) -- Damage, in standard damage points.
...
function SWEP:OnPaP()
	...
	self.Primary.NumShots = 4
	self.Primary.Damage = NZCoDDMG(232.5)
