...
SWEP.Primary.Sound = Sound("Weapon_BO2_Rifles.fire_4") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Damage = NZCoDDMG(92.5) -- Damage, in standard damage points.
