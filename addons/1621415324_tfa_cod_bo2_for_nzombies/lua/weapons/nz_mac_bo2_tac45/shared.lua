...
hook.Add( "PlayerCanPickupWeapon", "setammo_tac45", function( ply, wep )
	timer.Simple(0.1, function()
		if IsValid(wep) and wep:GetClass() == "nz_mac_bo2_tac45" and ply:GetAmmoCount( "nz_weapon_ammo_1" ) > 40 and !wep:HasNZModifier("pap") then
