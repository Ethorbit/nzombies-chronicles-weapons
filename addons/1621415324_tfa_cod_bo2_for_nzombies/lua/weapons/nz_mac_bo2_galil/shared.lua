...
SWEP.Primary.Sound = Sound("Weapon_BO2_Rifles.fire_1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SoundEchoTable = {
	[0] = Sound("Weapon_BO2_Rifles.TailInside"), -- This is the sound of the weapon, when you shoot.
	[128] = Sound("Weapon_BO2_Rifles.TailOutside") -- This is the sound of the weapon, when you shoot.
}
...
-- else
-- 		self.Owner:GetViewModel():SetSubMaterial(0, "bo1/weapons/galil/galil.vmt")
-- end
-- end
