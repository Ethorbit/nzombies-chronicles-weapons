...
SWEP.PrintName				= "Remington New Model Army"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.SoundEchoTable = {
	[0] = Sound("Weapon_BO2_RNMA.TailInside"), -- This is the sound of the weapon, when you shoot.
	[256] = Sound("Weapon_BO2_RNMA.TailOutside") -- This is the sound of the weapon, when you shoot.
}
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = NZCoDDMG(650)
...
-- PaP Function
SWEP.NZPaPName				= "Sassafras"
function SWEP:OnPaP()
self.MuzzleFlashEffect = "pap_muzzleflash"
self.Ispackapunched = 1
self.Primary.Damage = NZCoDDMG(800)
...
--Recoil Related
SWEP.Primary.KickUp = 0.51 -- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/bo2/nzc_c_bo2_nma.mdl" --Viewmodel path
...
SWEP.VMAng = Vector(0,0,0) --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.e
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/bo2/nzc_w_bo2_nma.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector(-9,15,0) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-3.99,0,0.65) --Change this, using SWEP Creation Kit preferably
...
SWEP.EventTable = {
    [ACT_VM_RELOAD] = {
	{ ["time"] = 3 / 30, ["type"] = "sound", ["value"] = Sound("Weapon_BO2_RNMA.Hammer") },
	{ ["time"] = 14 / 30, ["type"] = "sound", ["value"] = Sound("Weapon_BO2_RNMA.Stock") },
	{ ["time"] = 31 / 30, ["type"] = "sound", ["value"] = Sound("Weapon_BO2_RNMA.Clipout") },
	{ ["time"] = 61 / 30, ["type"] = "sound", ["value"] = Sound("Weapon_BO2_RNMA.Clipin") },
	{ ["time"] = 72 / 30, ["type"] = "sound", ["value"] = Sound("Weapon_BO2_RNMA.Stock") },
	{ ["time"] = 89 / 30, ["type"] = "sound", ["value"] = Sound("Weapon_BO2_RNMA.End") },
    },
	[ACT_VM_DRAW_DEPLOYED] = {
	{ ["time"] = 1 / 30, ["type"] = "sound", ["value"] = Sound("Weapon_BO2_RNMA.Deploy") },
    },
}
