...
SWEP.NZPaPName = "Rocket Propelled Grievance"
...
SWEP.ViewModel				= "models/weapons/c_bo2_usrpg.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_bo2_usrpg.mdl"	-- Weapon world model
...
SWEP.ProjectileRadius = NZCoDRadius(6.3)
...
SWEP.ViewModelBoneMods = {
	["tag_view"] = { scale = Vector(1, 1, 1), pos = Vector(-0.728, 1.21, -1.384), angle = Angle(0, 0, 0) }
}
