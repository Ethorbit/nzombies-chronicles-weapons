...
SWEP.PrintName				= "AK74u"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound = Sound("Weapon_BO2_Smgs.fire_1") -- This is the sound of the weapon, when you shoot.
...
function SWEP:OnPaP()
	...
	self.Primary.Damage = NZCoDDMG(165)
