...
SWEP.PrintName				= "Colt M16A1"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound = Sound("Weapon_BO2_Rifles.fire_2") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SoundEchoTable = {
	[0] = Sound("Weapon_BO2_Rifles.TailInside"), -- This is the sound of the weapon, when you shoot.
	[256] = Sound("Weapon_BO2_Rifles.TailOutside") -- This is the sound of the weapon, when you shoot.
}
SWEP.Primary.Sound_SIL			= Sound("robotnik_bo1_commando.Silenced")		-- Script that calls the primary fire sound
SWEP.Primary.RPM			= 511			-- This is in Rounds Per Minute
SWEP.Primary.RPM_Burst	= 750
SWEP.Primary.RPM_Semi   = 937
...
SWEP.Primary.Damage = NZCoDDMG(85) -- Damage, in standard damage points.
